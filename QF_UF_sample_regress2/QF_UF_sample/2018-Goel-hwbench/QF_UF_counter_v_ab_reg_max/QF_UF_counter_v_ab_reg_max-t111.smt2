...
(assert (not (= y$28 (= (not y$26) (not (= y$X$next y$n15s4))))))
(assert (= y$28 (= y$prop$next (not (= y$X$next y$n15s4)))))
(assert (= (= y$prop$next (not (= y$X$next y$n15s4))) (= (not y$26) (not (= y$X$next y$n15s4)))))
(check-sat)
(exit)
