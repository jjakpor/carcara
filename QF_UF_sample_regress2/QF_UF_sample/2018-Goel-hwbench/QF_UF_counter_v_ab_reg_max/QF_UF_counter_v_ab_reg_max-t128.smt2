...
(assert (not (= (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) (ite (= y$n1s4 y$n15s4) y$n1s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(assert (= y$n1s4 y$n1s4))
(assert (= (= y$X y$n15s4) (= y$n1s4 y$n15s4)))
(assert (= (Add_4_4_4 y$X y$n1s4) (Add_4_4_4 y$n1s4 y$n1s4)))
(check-sat)
(exit)
