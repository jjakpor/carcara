...
(assert (not (= (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)) false)))
(assert (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))
(assert (or (= (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)) false) (not (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))))
(assert (or (not (not (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))) (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))
(check-sat)
(exit)
