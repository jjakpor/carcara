...
(assert (not (= (and (not (= y$n0s8 y$n1s8)) (not (= y$n0s8 y$n255s8)) (not (= y$n0s8 y$n5s8)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$n5s8)) (not (= y$n255s8 y$n5s8))) false)))
(assert (= (and (not (= y$n0s8 y$n1s8)) (not (= y$n0s8 y$n255s8)) (not (= y$n0s8 y$n5s8)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$n5s8)) (not (= y$n255s8 y$n5s8))) (and (not (= y$v_k_Table y$n1s8)) (not (= y$v_k_Table y$n255s8)) (not (= y$v_k_Table y$v_k_Table)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$v_k_Table)) (not (= y$n255s8 y$v_k_Table)))))
(assert (= (and (not (= y$v_k_Table y$n1s8)) (not (= y$v_k_Table y$n255s8)) (not (= y$v_k_Table y$v_k_Table)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$v_k_Table)) (not (= y$n255s8 y$v_k_Table))) false))
(check-sat)
(exit)
