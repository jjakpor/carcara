...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (not (= (= (not (not (= (f6 c_1) (f5 c_1)))) (= (f6 c_1) (f5 c_1))) true)))
(assert (= (= (not (not (= (f6 c_1) (f5 c_1)))) (= (f6 c_1) (f5 c_1))) (= (= (f6 c_1) (f5 c_1)) (not (not (= (f6 c_1) (f5 c_1)))))))
(assert (= (= (= (f6 c_1) (f5 c_1)) (not (not (= (f6 c_1) (f5 c_1))))) true))
(check-sat)
(exit)
