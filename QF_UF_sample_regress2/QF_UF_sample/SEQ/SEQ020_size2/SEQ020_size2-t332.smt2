...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (not (or (= c_0 (f6 c_1)) (= c_1 (f6 c_1)))))
(assert (or (not (= (or (= (f6 c_1) c_0) (= (f6 c_1) c_1)) (or (= c_0 (f6 c_1)) (= c_1 (f6 c_1))))) (not (or (= (f6 c_1) c_0) (= (f6 c_1) c_1))) (or (= c_0 (f6 c_1)) (= c_1 (f6 c_1)))))
(assert (= (or (= (f6 c_1) c_0) (= (f6 c_1) c_1)) (or (= c_0 (f6 c_1)) (= c_1 (f6 c_1)))))
(assert (or (= (f6 c_1) c_0) (= (f6 c_1) c_1)))
(check-sat)
(exit)
