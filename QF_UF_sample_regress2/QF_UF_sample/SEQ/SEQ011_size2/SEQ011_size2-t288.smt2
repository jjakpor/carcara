...
(assert (not (not (and (= c_0 (f5 c_0)) (= c_0 (f6 c_0))))))
(assert (not (not (and (= c_0 (f5 c_0)) (= c_0 (f6 c_0))))))
(assert (or (not (= c_0 (f5 c_0))) (not (= c_0 (f6 c_0))) (= (f6 c_0) (f5 c_0))))
(assert (or (not (and (= c_0 (f5 c_0)) (= c_0 (f6 c_0)))) (= c_0 (f5 c_0))))
(assert (or (not (and (= c_0 (f5 c_0)) (= c_0 (f6 c_0)))) (= c_0 (f6 c_0))))
(check-sat)
(exit)
