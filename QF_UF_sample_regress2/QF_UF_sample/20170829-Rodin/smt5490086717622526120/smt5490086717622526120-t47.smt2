...
(assert (or (not (= (or (not red_SR) (not (not prt))) (or (not red_SR) prt))) (not (or (not red_SR) (not (not prt)))) (or (not red_SR) prt)))
(assert (= (or (not red_SR) (not (not prt))) (or (not red_SR) prt)))
(assert (or (not red_SR) (not (not prt))))
(check-sat)
(exit)
