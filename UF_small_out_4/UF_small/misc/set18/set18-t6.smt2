...
(assert (=> (forall ((?x Elem) (?s1 Set) (?s2 Set)) (or (not (member ?x ?s1)) (not (subset ?s1 ?s2)) (member ?x ?s2))) (or (not (member (choice ((?x Elem)) (not (or (not (member ?x (difference b a))) (member ?x (difference b d))))) d)) (not (subset d a)) (member (choice ((?x Elem)) (not (or (not (member ?x (difference b a))) (member ?x (difference b d))))) a))))
(check-sat)
(exit)
