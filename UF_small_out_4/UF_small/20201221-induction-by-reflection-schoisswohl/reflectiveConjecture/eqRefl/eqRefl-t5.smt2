...
(assert (not (= (= (models (push_alpha empty v0_alpha (choice ((x alpha)) (not (models (push_alpha empty v0_alpha x) (eq_alpha (inj_alpha v0_alpha) (inj_alpha v0_alpha)))))) (eq_alpha (inj_alpha v0_alpha) (inj_alpha v0_alpha))) true) (models (push_alpha empty v0_alpha (choice ((x alpha)) (not (models (push_alpha empty v0_alpha x) (eq_alpha (inj_alpha v0_alpha) (inj_alpha v0_alpha)))))) (eq_alpha (inj_alpha v0_alpha) (inj_alpha v0_alpha))))))
(check-sat)
(exit)
