...
(assert (not (= (models empty (pR aR)) (p (eval_alpha empty aR)))))
(assert (or (not (forall ((env env) (t0 term_alpha)) (= (models env (pR t0)) (p (eval_alpha env t0))))) (= (models empty (pR aR)) (p (eval_alpha empty aR)))))
(check-sat)
(exit)
