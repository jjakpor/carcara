...
(assert (not (not (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))))))
(assert (not (not (= (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (not (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))))))))
(assert (or (not (= (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (not (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))))) (not (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))))) (not (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))))))
(check-sat)
(exit)
