...
(assert (not (= (models empty (notR (orR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))) (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))) (models empty (notR (orR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))) (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))
(check-sat)
(exit)
