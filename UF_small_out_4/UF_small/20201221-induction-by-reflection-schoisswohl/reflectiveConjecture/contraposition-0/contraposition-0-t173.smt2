...
(assert (or (models empty (notR (pR aR))) (models empty (qR bR)) (not (or (models empty (notR (pR aR))) (models empty (qR bR))))))
(assert (not (models empty (notR (pR aR)))))
(assert (or (models empty (notR (pR aR))) (models empty (qR bR))))
(check-sat)
(exit)
