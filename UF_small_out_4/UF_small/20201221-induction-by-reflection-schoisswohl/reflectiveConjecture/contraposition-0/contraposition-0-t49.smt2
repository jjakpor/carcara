...
(assert (not (= (not (models empty (qR bR))) (models empty (notR (qR bR))))))
(assert (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (not (models empty (qR bR))) (models empty (notR (qR bR))))))
(check-sat)
(exit)
