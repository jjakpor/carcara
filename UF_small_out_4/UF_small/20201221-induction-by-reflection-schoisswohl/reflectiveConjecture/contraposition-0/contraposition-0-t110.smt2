...
(assert (not (or (not (forall ((env env) (phi form) (psi form)) (= (models env (orR phi psi)) (or (models env phi) (models env psi))))) (= (models empty (orR (notR (notR (orR (notR (pR aR)) (qR bR)))) (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR))))))) (or (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))))))
(check-sat)
(exit)
