...
(assert (not (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (models empty (notR (qR bR))) (not (models empty (qR bR)))))))
(assert (not (= (models empty (notR (qR bR))) (not (models empty (qR bR))))))
(assert (or (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (models empty (notR (qR bR))) (not (models empty (qR bR))))) (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))))
(assert (or (not (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))) (= (models empty (notR (qR bR))) (not (models empty (qR bR))))))
(check-sat)
(exit)
