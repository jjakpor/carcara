...
(assert (not (models empty (notR (notR (orR (notR (pR aR)) (qR bR)))))))
(assert (not (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR))))))))
(assert (not (not (or (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR))))))))))
(assert (or (not (or (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))) (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR))))))))
(check-sat)
(exit)
