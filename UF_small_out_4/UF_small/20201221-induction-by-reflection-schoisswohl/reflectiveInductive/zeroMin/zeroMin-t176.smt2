...
(assert (not (not (models (push_nat empty v0_nat (s (choice ((x0 nat)) (not (or (not (models (push_nat empty v0_nat x0) (leqR zeroR (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (leqR zeroR (inj_nat v0_nat)))))))) (leqR zeroR (inj_nat v0_nat))))))
(check-sat)
(exit)
