...
(assert (not (or (not (forall ((env env) (v var_nat)) (= (evalV_nat env v) (eval_nat env (inj_nat v))))) (= (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) v0_nat) (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (inj_nat v0_nat))))))
(check-sat)
(exit)
