...
(assert (not (not (= (not (forall ((x nat)) (equal x x x))) (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x)))))))))
(assert (not (not (not (forall ((x nat)) (equal x x x))))))
