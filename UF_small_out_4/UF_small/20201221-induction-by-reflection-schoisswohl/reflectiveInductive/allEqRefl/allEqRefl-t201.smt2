...
(assert (or (not (= (not (forall ((x nat)) (equal x x x))) (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))))))) (not (not (forall ((x nat)) (equal x x x)))) (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x)))))))
(assert (= (not (forall ((x nat)) (equal x x x))) (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x)))))))
(check-sat)
(exit)
