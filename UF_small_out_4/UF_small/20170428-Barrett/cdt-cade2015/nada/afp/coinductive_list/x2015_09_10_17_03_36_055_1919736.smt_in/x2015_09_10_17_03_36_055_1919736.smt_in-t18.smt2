...
(assert (not (= (= (llength$ us$) infinity$) (= (llength$ us$) (llength$a xs$)))))
(assert (= (= (llength$ us$) infinity$) (= infinity$ (llength$ us$))))
(assert (= (= infinity$ (llength$ us$)) (= (llength$ us$) (llength$a xs$))))
(check-sat)
(exit)
