...
(assert (not (= (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)) true)))
(assert (= (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)) (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$))))
(assert (= (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$)) true))
(check-sat)
(exit)
