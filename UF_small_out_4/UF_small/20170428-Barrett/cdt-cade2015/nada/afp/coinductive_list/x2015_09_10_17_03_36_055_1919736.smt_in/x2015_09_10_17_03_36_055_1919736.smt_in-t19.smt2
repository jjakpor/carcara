...
(assert (not (= (llength$ us$) (llength$a xs$))))
(assert (= (llength$ us$) infinity$))
(assert (or (not (= (= (llength$ us$) infinity$) (= (llength$ us$) (llength$a xs$)))) (not (= (llength$ us$) infinity$)) (= (llength$ us$) (llength$a xs$))))
(assert (= (= (llength$ us$) infinity$) (= (llength$ us$) (llength$a xs$))))
(check-sat)
(exit)
