...
(assert (not (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)))))
(assert (not (not (and (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))) (not (fun_app$h lnull$ xs$))))))
(assert (or (not (and (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))) (not (fun_app$h lnull$ xs$)))) (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)))))
(check-sat)
(exit)
