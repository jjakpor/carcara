...
(assert (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)) (not (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))))
(assert (not (fun_app$h lnull$ xs$)))
(assert (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))
(assert (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))
(check-sat)
(exit)
