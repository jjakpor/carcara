...
(assert (not (not (lfinite$ xs$))))
(assert (not (member$ xs$ (image$ llist_of$ (collect$a top$b)))))
(assert (not (not (= (lfinite$ xs$) (member$ xs$ (image$ llist_of$ (collect$a top$b)))))))
(assert (or (not (= (lfinite$ xs$) (member$ xs$ (image$ llist_of$ (collect$a top$b))))) (not (lfinite$ xs$)) (member$ xs$ (image$ llist_of$ (collect$a top$b)))))
(check-sat)
(exit)
