...
(assert (not (not (= (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$)) true))))
(assert (not (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$))))
(assert (= (= (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$)) true) (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$))))
(check-sat)
(exit)
