...
(declare-fun f25 () S8)
(declare-fun f26 () S6)
(assert (not (= (= (f17 (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) f26) (f7 (f18 (f19 (f20 (f21 f22 f5) (f12 f13 (f14 f25))) (f11 (f12 f13 (f14 f25))))) f23)) f1) (= f1 (f17 (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) f26) (f7 (f18 (f19 (f20 (f21 f22 f5) (f12 f13 (f14 f25))) (f11 (f12 f13 (f14 f25))))) f23))))))
(check-sat)
(exit)
