...
(declare-fun f25 () S8)
(declare-fun f26 () S6)
(assert (not (= (f17 f26 (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) f23)) (f17 f26 (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) (f24 f10))))))
(assert (= f26 f26))
(assert (= (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) f23) (f7 (f18 (f19 (f20 (f21 f22 f5) (f15 f16 f25)) (f11 (f15 f16 f25)))) (f24 f10))))
(check-sat)
(exit)
