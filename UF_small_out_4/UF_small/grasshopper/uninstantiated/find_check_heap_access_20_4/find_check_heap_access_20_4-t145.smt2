...
(declare-fun x$0 () Loc)
(assert (not (= sk_?X_25$0 (setenum$0 root_x$0))))
(assert (= sk_?X_25$0 sk_?X_26$0))
(assert (or (not (= (= sk_?X_25$0 sk_?X_26$0) (= sk_?X_25$0 (setenum$0 root_x$0)))) (not (= sk_?X_25$0 sk_?X_26$0)) (= sk_?X_25$0 (setenum$0 root_x$0))))
(assert (= (= sk_?X_25$0 sk_?X_26$0) (= sk_?X_25$0 (setenum$0 root_x$0))))
(check-sat)
(exit)
