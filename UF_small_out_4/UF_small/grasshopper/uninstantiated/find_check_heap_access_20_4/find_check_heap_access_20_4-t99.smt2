...
(declare-fun x$0 () Loc)
(assert (not (or (in$0 x$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0)) (in$0 x$0 (setenum$0 root_x$0)))))
(assert (not (not (and (in$0 x$0 (union$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0))) (or (in$0 x$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0)) (in$0 x$0 (setenum$0 root_x$0)))))))
(assert (or (not (and (in$0 x$0 (union$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0))) (or (in$0 x$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0)) (in$0 x$0 (setenum$0 root_x$0))))) (or (in$0 x$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0)) (in$0 x$0 (setenum$0 root_x$0)))))
(check-sat)
(exit)
