...
(declare-fun x$0 () Loc)
(assert (not (not (= (= X_27$0 (lseg_set_X$0 next$0 n_5$0 root_x$0)) (= X_27$0 (lseg_set_X$0 next$0 (read$0 next$0 x$0) root_x$0))))))
(assert (not (not (= X_27$0 (lseg_set_X$0 next$0 n_5$0 root_x$0)))))
