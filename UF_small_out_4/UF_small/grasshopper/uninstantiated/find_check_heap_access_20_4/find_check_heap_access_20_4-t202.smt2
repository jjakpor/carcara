...
(declare-fun x$0 () Loc)
(assert (not (= root_x$0 x$0)))
(assert (not (not (Btwn$0 next$0 (read$0 next$0 x$0) x$0 root_x$0))))
(assert (not (not (or (= root_x$0 x$0) (not (Btwn$0 next$0 (read$0 next$0 x$0) x$0 root_x$0))))))
(assert (or (not (or (= root_x$0 x$0) (not (Btwn$0 next$0 (read$0 next$0 x$0) x$0 root_x$0)))) (= root_x$0 x$0) (not (Btwn$0 next$0 (read$0 next$0 x$0) x$0 root_x$0))))
(check-sat)
(exit)
