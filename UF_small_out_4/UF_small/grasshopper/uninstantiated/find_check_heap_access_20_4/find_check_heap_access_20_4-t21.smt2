...
(declare-fun x$0 () Loc)
(assert (not (= (read$0 next_2$0 x$0) (read$0 next$0 x$0))))
(assert (not (not (and (= root_x$0 x$0) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))))))
(assert (not (not (and (= root_x$0 x$0) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))))))
(assert (or (not (= root_x$0 x$0)) (not (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))) (= (read$0 next_2$0 x$0) (read$0 next$0 x$0))))
(assert (or (not (and (= root_x$0 x$0) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0)))) (= root_x$0 x$0)))
(assert (or (not (and (= root_x$0 x$0) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0)))) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))))
(check-sat)
(exit)
