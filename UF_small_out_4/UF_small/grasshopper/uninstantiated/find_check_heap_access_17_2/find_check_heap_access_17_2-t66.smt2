...
(declare-fun x$0 () Loc)
(assert (not (not (forall ((BOUND_VARIABLE_557 Loc)) (in$0 BOUND_VARIABLE_557 (setenum$0 BOUND_VARIABLE_557))))))
(assert (not (in$0 root_x$0 (setenum$0 root_x$0))))
(assert (or (not (forall ((BOUND_VARIABLE_557 Loc)) (in$0 BOUND_VARIABLE_557 (setenum$0 BOUND_VARIABLE_557)))) (in$0 root_x$0 (setenum$0 root_x$0))))
(check-sat)
(exit)
