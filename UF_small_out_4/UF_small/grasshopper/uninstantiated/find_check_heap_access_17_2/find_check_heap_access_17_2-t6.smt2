...
(assert (not (not (and (Btwn$0 next$0 x$0 x$0 root_x$0) (Btwn$0 next$0 x$0 root_x$0 x$0)))))
(assert (or (not (and (Btwn$0 next$0 x$0 x$0 root_x$0) (Btwn$0 next$0 x$0 root_x$0 x$0))) (Btwn$0 next$0 x$0 x$0 root_x$0)))
(check-sat)
(exit)
