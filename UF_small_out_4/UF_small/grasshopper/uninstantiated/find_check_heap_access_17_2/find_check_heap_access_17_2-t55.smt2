...
(assert (= FP$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0)))
(assert (= (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0) (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) (setenum$0 root_x$0))))
(check-sat)
(exit)
