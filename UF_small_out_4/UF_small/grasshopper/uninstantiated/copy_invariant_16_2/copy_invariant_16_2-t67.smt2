...
(assert (not (= (not (Btwn$0 next$0 cp_2$0 null$0 null$0)) (not (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0)))))
(assert (= (Btwn$0 next$0 cp_2$0 null$0 null$0) (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0)))
(check-sat)
(exit)
