...
(assert (not (= (not (in$0 curr_2$0 (lseg_domain$0 next$0 lst$0 curr_2$0))) (not (in$0 lst$0 (lseg_domain$0 next$0 lst$0 lst$0))))))
(assert (= (in$0 curr_2$0 (lseg_domain$0 next$0 lst$0 curr_2$0)) (in$0 lst$0 (lseg_domain$0 next$0 lst$0 lst$0))))
(check-sat)
(exit)
