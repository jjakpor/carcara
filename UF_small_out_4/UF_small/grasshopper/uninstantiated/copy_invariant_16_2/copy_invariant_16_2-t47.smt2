...
(assert (not (= (= sk_?X_1$0 (union$0 sk_?X_3$0 sk_?X_2$0)) (= sk_FP$0 (union$0 sk_?X_3$0 (lseg_domain$0 next$0 cp_2$0 cp_2$0))))))
(assert (= sk_?X_1$0 sk_FP$0))
(assert (= (union$0 sk_?X_3$0 sk_?X_2$0) (union$0 sk_?X_3$0 (lseg_domain$0 next$0 cp_2$0 cp_2$0))))
(check-sat)
(exit)
