...
(assert (not (not (= (= sk_?X_2$0 (lseg_domain$0 next$0 cp_2$0 null$0)) (= sk_?X_2$0 (lseg_domain$0 next$0 cp_2$0 cp_2$0))))))
(assert (not (not (= sk_?X_2$0 (lseg_domain$0 next$0 cp_2$0 null$0)))))
