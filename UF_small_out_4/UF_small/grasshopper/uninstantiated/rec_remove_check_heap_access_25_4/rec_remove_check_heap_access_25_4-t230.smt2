...
(assert (not (or (not (forall ((?f FldLoc) (?u Loc) (?x Loc) (?y Loc) (?z Loc)) (or (not (Btwn$0 ?f ?x ?y ?z)) (not (Btwn$0 ?f ?x ?u ?y)) (and (Btwn$0 ?f ?x ?u ?z) (Btwn$0 ?f ?u ?y ?z))))) (or (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0)) (not (Btwn$0 next$0 lst$0 lst$0 (read$0 next$0 lst$0))) (and (Btwn$0 next$0 lst$0 lst$0 null$0) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0))))))
(check-sat)
(exit)
