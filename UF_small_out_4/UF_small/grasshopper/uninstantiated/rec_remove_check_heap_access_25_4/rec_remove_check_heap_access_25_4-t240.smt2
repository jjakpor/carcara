...
(assert (not (or (not (forall ((?f FldLoc) (?x Loc) (?y Loc) (?z Loc)) (or (not (Btwn$0 ?f ?x ?y ?y)) (not (Btwn$0 ?f ?x ?z ?z)) (Btwn$0 ?f ?x ?y ?z) (Btwn$0 ?f ?x ?z ?y)))) (or (not (Btwn$0 next$0 lst$0 lst$0 lst$0)) (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) (read$0 next$0 lst$0))) (Btwn$0 next$0 lst$0 lst$0 (read$0 next$0 lst$0)) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) lst$0)))))
(check-sat)
(exit)
