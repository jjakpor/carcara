...
(assert (not (= (and (or (= null$0 null$0) (not (Btwn$0 next$0 n1_2$0 null$0 null$0))) (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0)))) (and true (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0)))))))
(assert (= (or (= null$0 null$0) (not (Btwn$0 next$0 n1_2$0 null$0 null$0))) true))
(assert (= (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0))) (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0)))))
(check-sat)
(exit)
