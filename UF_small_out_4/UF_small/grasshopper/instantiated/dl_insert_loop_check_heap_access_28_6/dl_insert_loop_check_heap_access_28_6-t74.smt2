...
(assert (not (= (and (= null$0 (read$0 next$0 d_init$0)) (= prv_init$0 (read$0 prev$0 curr_init$0)) (in$0 d_init$0 sk_?X_92$0)) (and (= (read$0 next$0 d_init$0) (read$0 next$0 d_init$0)) (= (read$0 prev$0 prv_5$0) (read$0 prev$0 prv_5$0)) (in$0 d_init$0 (dlseg_domain$0 next$0 prev$0 prv_5$0 (read$0 prev$0 prv_5$0) (read$0 next$0 d_init$0) d_init$0))))))
(assert (= (= null$0 (read$0 next$0 d_init$0)) (= (read$0 next$0 d_init$0) (read$0 next$0 d_init$0))))
(assert (= (= prv_init$0 (read$0 prev$0 curr_init$0)) (= (read$0 prev$0 prv_5$0) (read$0 prev$0 prv_5$0))))
(assert (= (in$0 d_init$0 sk_?X_92$0) (in$0 d_init$0 (dlseg_domain$0 next$0 prev$0 prv_5$0 (read$0 prev$0 prv_5$0) (read$0 next$0 d_init$0) d_init$0))))
(check-sat)
(exit)
