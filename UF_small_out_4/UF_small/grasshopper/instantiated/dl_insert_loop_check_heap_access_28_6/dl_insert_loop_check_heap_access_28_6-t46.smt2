...
(assert (not (= curr_init$0 prv_5$0)))
(assert (or (not (= (= curr_4$0 prv_5$0) (= curr_init$0 prv_5$0))) (not (= curr_4$0 prv_5$0)) (= curr_init$0 prv_5$0)))
(assert (= (= curr_4$0 prv_5$0) (= curr_init$0 prv_5$0)))
