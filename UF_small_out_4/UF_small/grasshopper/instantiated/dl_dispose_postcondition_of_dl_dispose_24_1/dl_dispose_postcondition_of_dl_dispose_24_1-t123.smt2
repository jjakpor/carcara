...
(assert (not (= (or (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (= sk_?e$0 prv_2$0)) (or (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (= prv_2$0 sk_?e$0)))))
(assert (= (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0))))
(assert (= (= sk_?e$0 prv_2$0) (= prv_2$0 sk_?e$0)))
(check-sat)
(exit)
