...
(assert (not (= prv_2$0 sk_?e$0)))
(assert (not (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0))))
(assert (not (not (or (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (= prv_2$0 sk_?e$0)))))
(assert (or (not (or (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (= prv_2$0 sk_?e$0))) (not (Btwn$0 next$0 prv_2$0 sk_?e$0 prv_2$0)) (= prv_2$0 sk_?e$0)))
(check-sat)
(exit)
