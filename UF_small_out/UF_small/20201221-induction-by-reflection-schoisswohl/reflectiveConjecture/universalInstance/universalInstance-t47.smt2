...
(assert (not (not (= (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))) (not (models empty (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha)))))))))
(assert (not (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha)))))))
(assert (not (models empty (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))))
(assert (or (not (= (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))) (not (models empty (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))))) (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))) (models empty (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))))
(check-sat)
(exit)
