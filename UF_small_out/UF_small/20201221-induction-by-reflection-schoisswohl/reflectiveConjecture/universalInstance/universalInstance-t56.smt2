...
(assert (or (or (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))) (models empty (pR aR))) (not (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))))))
(assert (not (or (models empty (notR (forallR_alpha v0_alpha (pR (inj_alpha v0_alpha))))) (models empty (pR aR)))))
(check-sat)
(exit)
