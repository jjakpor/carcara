...
(assert (not (models empty (notR (pR aR)))))
(assert (not (models empty (orR (notR (qR bR)) (rR cR)))))
(assert (not (not (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR)))))))
(assert (or (not (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR))))) (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR)))))
(check-sat)
(exit)
