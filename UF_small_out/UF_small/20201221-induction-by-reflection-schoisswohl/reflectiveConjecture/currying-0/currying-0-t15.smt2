...
(assert (not (not (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))))))
(assert (not (not (models empty (notR (orR (notR (pR aR)) (notR (qR bR))))))))
(assert (not (not (= (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (not (models empty (notR (orR (notR (pR aR)) (notR (qR bR))))))))))
(assert (or (not (= (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (not (models empty (notR (orR (notR (pR aR)) (notR (qR bR)))))))) (not (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR))))))) (not (models empty (notR (orR (notR (pR aR)) (notR (qR bR))))))))
(check-sat)
(exit)
