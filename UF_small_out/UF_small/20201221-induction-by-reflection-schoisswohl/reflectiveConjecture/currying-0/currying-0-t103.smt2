...
(assert (not (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))))))
(assert (not (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))
(assert (not (not (or (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))
(assert (or (not (or (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))))))) (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))
(check-sat)
(exit)
