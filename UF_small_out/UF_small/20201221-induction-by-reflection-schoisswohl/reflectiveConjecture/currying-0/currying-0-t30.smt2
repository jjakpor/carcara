...
(assert (not (not (models empty (orR (notR (qR bR)) (rR cR))))))
(assert (not (or (models empty (notR (qR bR))) (models empty (rR cR)))))
(assert (not (not (= (models empty (orR (notR (qR bR)) (rR cR))) (or (models empty (notR (qR bR))) (models empty (rR cR)))))))
