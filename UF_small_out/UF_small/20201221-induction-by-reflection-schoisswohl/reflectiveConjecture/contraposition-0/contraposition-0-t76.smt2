...
(assert (not (models empty (orR (notR (pR aR)) (qR bR)))))
(assert (not (not (or (models empty (notR (pR aR))) (models empty (qR bR))))))
(assert (not (not (= (models empty (orR (notR (pR aR)) (qR bR))) (or (models empty (notR (pR aR))) (models empty (qR bR)))))))
(assert (or (not (= (models empty (orR (notR (pR aR)) (qR bR))) (or (models empty (notR (pR aR))) (models empty (qR bR))))) (models empty (orR (notR (pR aR)) (qR bR))) (not (or (models empty (notR (pR aR))) (models empty (qR bR))))))
(check-sat)
(exit)
