...
(assert (not (not (models empty (orR (notR (pR aR)) (qR bR))))))
(assert (not (or (models empty (notR (pR aR))) (models empty (qR bR)))))
(assert (not (not (= (models empty (orR (notR (pR aR)) (qR bR))) (or (models empty (notR (pR aR))) (models empty (qR bR)))))))
(assert (or (not (= (models empty (orR (notR (pR aR)) (qR bR))) (or (models empty (notR (pR aR))) (models empty (qR bR))))) (not (models empty (orR (notR (pR aR)) (qR bR)))) (or (models empty (notR (pR aR))) (models empty (qR bR)))))
(check-sat)
(exit)
