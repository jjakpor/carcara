...
(assert (not (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))
(assert (not (models empty (orR (notR (notR (qR bR))) (notR (pR aR))))))
(assert (or (not (= (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR))))) (not (models empty (orR (notR (notR (qR bR))) (notR (pR aR))))))) (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR))))) (models empty (orR (notR (notR (qR bR))) (notR (pR aR))))))
(check-sat)
(exit)
