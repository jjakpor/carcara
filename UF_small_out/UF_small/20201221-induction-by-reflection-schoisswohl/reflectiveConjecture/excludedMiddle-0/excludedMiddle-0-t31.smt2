...
(assert (not (not (= (models empty (notR (pR aR))) (not (models empty (pR aR)))))))
(assert (or (models empty (pR aR)) (models empty (notR (pR aR))) (not (= (models empty (notR (pR aR))) (not (models empty (pR aR)))))))
(assert (not (models empty (pR aR))))
