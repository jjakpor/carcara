...
(assert (not (= (or (not (= (models empty (notR (pR aR))) (not (models empty (pR aR))))) (models empty (notR (pR aR))) (not (not (models empty (pR aR))))) (or (not (= (models empty (notR (pR aR))) (not (models empty (pR aR))))) (models empty (notR (pR aR))) (models empty (pR aR))))))
(assert (= (not (= (models empty (notR (pR aR))) (not (models empty (pR aR))))) (not (= (models empty (notR (pR aR))) (not (models empty (pR aR)))))))
(assert (= (models empty (notR (pR aR))) (models empty (notR (pR aR)))))
(assert (= (not (not (models empty (pR aR)))) (models empty (pR aR))))
(check-sat)
(exit)
