...
(assert (not (= zero (evalV_nat (push_nat empty v0_nat zero) v0_nat))))
(assert (or (not (forall ((env env) (v var_nat) (x nat)) (= x (evalV_nat (push_nat env v x) v)))) (= zero (evalV_nat (push_nat empty v0_nat zero) v0_nat))))
(check-sat)
(exit)
