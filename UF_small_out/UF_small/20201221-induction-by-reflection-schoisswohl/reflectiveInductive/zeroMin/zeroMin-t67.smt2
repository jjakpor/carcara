...
(assert (not (= (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) zero)))
(assert (= (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (evalV_nat (push_nat empty v0_nat zero) v0_nat)))
(assert (= (evalV_nat (push_nat empty v0_nat zero) v0_nat) zero))
(check-sat)
(exit)
