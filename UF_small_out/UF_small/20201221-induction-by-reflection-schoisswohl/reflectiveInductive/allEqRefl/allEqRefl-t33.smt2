...
(assert (or (not (forall ((env env) (v var_nat) (x nat)) (= x (evalV_nat (push_nat env v x) v)))) (= (choice ((x nat)) (not (equal x x x))) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) v0_nat))))
(check-sat)
(exit)
