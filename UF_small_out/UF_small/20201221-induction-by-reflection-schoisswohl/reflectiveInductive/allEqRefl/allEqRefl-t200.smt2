...
(assert (not (= (not (forall ((x nat)) (equal x x x))) (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))))))))
(assert (= (forall ((x nat)) (equal x x x)) (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))))))
(check-sat)
(exit)
