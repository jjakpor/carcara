...
(assert (not (not (= (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)) true))))
(assert (not (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$))))
(assert (= (= (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)) true) (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$))))
(check-sat)
(exit)
