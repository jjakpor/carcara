...
(assert (not (not (forall ((?v0 A_llist$)) (= (lfinite$ ?v0) (member$ ?v0 (image$ llist_of$ (collect$a top$b))))))))
(assert (not (= (lfinite$ xs$) (member$ xs$ (image$ llist_of$ (collect$a top$b))))))
(assert (or (not (forall ((?v0 A_llist$)) (= (lfinite$ ?v0) (member$ ?v0 (image$ llist_of$ (collect$a top$b)))))) (= (lfinite$ xs$) (member$ xs$ (image$ llist_of$ (collect$a top$b))))))
(check-sat)
(exit)
