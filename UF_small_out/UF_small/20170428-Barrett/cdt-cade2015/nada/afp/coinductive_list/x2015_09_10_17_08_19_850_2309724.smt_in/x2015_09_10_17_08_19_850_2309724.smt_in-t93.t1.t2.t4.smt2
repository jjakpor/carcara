...
(assert (not (= (forall ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (or (not (= ?v3 (lCons$ ?v7 ?v5))) (not (= ?v4 (lCons$ ?v7 ?v6))) (and (not (fun_app$m (fun_app$n ?v0 ?v5) ?v6)) (not (fun_app$m (fun_app$n lprefix$ ?v5) ?v6))))) (forall ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (or (not (= ?v3 (lCons$ ?v7 ?v5))) (not (= ?v4 (lCons$ ?v7 ?v6))) (and (not (fun_app$m (fun_app$n ?v0 ?v5) ?v6)) (not (fun_app$m (fun_app$n finite_lprefix$ ?v5) ?v6))))))))
