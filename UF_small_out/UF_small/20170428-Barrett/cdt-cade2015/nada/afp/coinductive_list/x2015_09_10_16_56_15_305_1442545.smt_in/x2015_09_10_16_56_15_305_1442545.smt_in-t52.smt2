...
(assert (not (= zero$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))
(assert (= zero$ (fun_app$n llength$b lNil$)))
(assert (= (fun_app$n llength$b lNil$) (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)))
(check-sat)
(exit)
