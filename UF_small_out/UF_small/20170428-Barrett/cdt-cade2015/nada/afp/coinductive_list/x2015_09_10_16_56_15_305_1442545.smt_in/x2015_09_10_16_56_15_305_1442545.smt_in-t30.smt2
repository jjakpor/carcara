...
(assert (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))
(assert (not (and (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))) (not (fun_app$h lnull$ xs$)))))
(assert (or (and (not (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))) (not (fun_app$h lnull$ xs$))) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)) (fun_app$h lnull$ xs$)))
(check-sat)
(exit)
