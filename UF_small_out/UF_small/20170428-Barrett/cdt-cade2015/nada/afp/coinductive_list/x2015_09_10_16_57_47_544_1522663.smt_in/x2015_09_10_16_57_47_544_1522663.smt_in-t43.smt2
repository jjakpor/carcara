...
(assert (not (not (forall ((?v0 A_llist$) (?v1 Nat$)) (= (fun_app$h (uvn$ ?v0) ?v1) (fun_app$c (ldropn$ ?v1) ?v0))))))
(assert (not (= (fun_app$h (uvn$ (ltl$ xs$)) n$) (fun_app$c (ldropn$ n$) (ltl$ xs$)))))
(assert (or (not (forall ((?v0 A_llist$) (?v1 Nat$)) (= (fun_app$h (uvn$ ?v0) ?v1) (fun_app$c (ldropn$ ?v1) ?v0)))) (= (fun_app$h (uvn$ (ltl$ xs$)) n$) (fun_app$c (ldropn$ n$) (ltl$ xs$)))))
(check-sat)
(exit)
