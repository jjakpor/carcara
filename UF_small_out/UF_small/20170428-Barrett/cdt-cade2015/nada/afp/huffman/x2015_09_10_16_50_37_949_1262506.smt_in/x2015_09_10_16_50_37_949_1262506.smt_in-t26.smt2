...
(assert (not (= (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$)) true)))
(assert (= (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$)) (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$))))
(assert (= (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$)) true))
(check-sat)
(exit)
