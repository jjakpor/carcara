...
(assert (not (= (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$)) true)))
(assert (not (not (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$)))))
(assert (= (= (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$)) true) (fun_app$b (less_eq$ (depth$ t$ a$)) (height$ t$))))
(check-sat)
(exit)
