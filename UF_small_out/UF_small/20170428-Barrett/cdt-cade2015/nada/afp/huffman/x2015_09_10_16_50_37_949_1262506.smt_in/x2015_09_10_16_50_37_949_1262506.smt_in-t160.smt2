...
(assert (not (= (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$)) true)))
(assert (= (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$)) (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$))))
(assert (= (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$)) true))
(check-sat)
(exit)
