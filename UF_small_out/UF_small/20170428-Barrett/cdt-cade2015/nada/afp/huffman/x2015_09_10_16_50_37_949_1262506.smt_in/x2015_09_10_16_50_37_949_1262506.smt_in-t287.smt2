...
(assert (not (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$)))))
(assert (not (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$)))))
(assert (not (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$)))))
(assert (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))))
(assert (or (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))) (not (not (= b$ c$)))))
(assert (or (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))) (not (not (not (= c$ d$))))))
(assert (or (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))) (not (not (= b$ d$)))))
(check-sat)
(exit)
