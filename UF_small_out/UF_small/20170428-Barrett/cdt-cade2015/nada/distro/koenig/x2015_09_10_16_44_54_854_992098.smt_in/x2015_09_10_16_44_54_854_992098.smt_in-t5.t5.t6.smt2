...
(assert (not (= (forall ((?v4 A_treeFI$)) (or (not (= ?v0 ?v0)) (not (= ?v1 ?v1)) (not (= (shd$ ?v0) (lab$ ?v1))) (not (member$ ?v4 (set$ (sub$ ?v1)))) (not (fun_app$a (properPath$ (stl$ ?v0)) ?v4)))) (forall ((?v4 A_treeFI$)) (or (not (= (shd$ ?v0) (lab$ ?v1))) (not (member$ ?v4 (set$ (sub$ ?v1)))) (not (fun_app$a (properPath$ (stl$ ?v0)) ?v4)))))))
(check-sat)
(exit)
