...
(assert (not (= (= sk_?X_3$0 (dlseg_domain$0 next$0 prev$0 a$0 prv_2$0 null$0 b$0)) (= sk_?X_3$0 (dlseg_domain$0 next$0 prev$0 a$0 prv_2$0 prv_2$0 b_1$0)))))
(assert (= sk_?X_3$0 sk_?X_3$0))
(assert (= (dlseg_domain$0 next$0 prev$0 a$0 prv_2$0 null$0 b$0) (dlseg_domain$0 next$0 prev$0 a$0 prv_2$0 prv_2$0 b_1$0)))
(check-sat)
(exit)
