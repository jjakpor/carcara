...
(assert (not (= (= sk_?X_2$0 (dlseg_domain$0 next$0 prev$0 a_1$0 prv_3$0 null$0 b_1$0)) (= sk_?X_2$0 (dlseg_domain$0 next$0 prev$0 prv_2$0 prv_3$0 prv_2$0 b_1$0)))))
(assert (= sk_?X_2$0 sk_?X_2$0))
