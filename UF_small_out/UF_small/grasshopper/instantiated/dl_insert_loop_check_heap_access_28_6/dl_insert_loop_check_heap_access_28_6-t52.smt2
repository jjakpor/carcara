...
(assert (not (not (= prv_5$0 (read$0 next$0 d_init$0)))))
(assert (not (= curr_init$0 null$0)))
(assert (or (not (= (not (= curr_init$0 null$0)) (not (= prv_5$0 (read$0 next$0 d_init$0))))) (not (not (= curr_init$0 null$0))) (not (= prv_5$0 (read$0 next$0 d_init$0)))))
(assert (= (not (= curr_init$0 null$0)) (not (= prv_5$0 (read$0 next$0 d_init$0)))))
(check-sat)
(exit)
