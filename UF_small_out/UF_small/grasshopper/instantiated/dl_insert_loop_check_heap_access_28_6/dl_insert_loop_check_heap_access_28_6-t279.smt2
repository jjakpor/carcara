...
(assert (or (= prv_5$0 (read$0 next$0 d_init$0)) (not (Btwn$0 next$0 prv_5$0 (read$0 next$0 d_init$0) prv_5$0)) (not (or (not (Btwn$0 next$0 prv_5$0 (read$0 next$0 d_init$0) prv_5$0)) (= prv_5$0 (read$0 next$0 d_init$0))))))
(assert (not (= prv_5$0 (read$0 next$0 d_init$0))))
(assert (Btwn$0 next$0 prv_5$0 (read$0 next$0 d_init$0) prv_5$0))
(check-sat)
(exit)
