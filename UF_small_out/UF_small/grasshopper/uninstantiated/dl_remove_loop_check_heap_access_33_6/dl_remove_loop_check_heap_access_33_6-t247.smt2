...
(assert (not (= (or (= null$0 null$0) (not (Btwn$0 next$0 curr_init$0 null$0 null$0))) true)))
(assert (= (or (= null$0 null$0) (not (Btwn$0 next$0 curr_init$0 null$0 null$0))) (or true (not (Btwn$0 next$0 curr_init$0 null$0 null$0)))))
(assert (= (or true (not (Btwn$0 next$0 curr_init$0 null$0 null$0))) true))
(check-sat)
(exit)
