...
(assert (not (= (= sk_?X_76$0 (dlseg_domain$0 next$0 prev$0 curr_init$0 prv_init$0 null$0 d_init$0)) (= sk_?X_76$0 (dlseg_domain$0 next$0 prev$0 prv_5$0 prv_init$0 null$0 d_init$0)))))
(assert (= sk_?X_76$0 sk_?X_76$0))
(assert (= (dlseg_domain$0 next$0 prev$0 curr_init$0 prv_init$0 null$0 d_init$0) (dlseg_domain$0 next$0 prev$0 prv_5$0 prv_init$0 null$0 d_init$0)))
(check-sat)
(exit)
