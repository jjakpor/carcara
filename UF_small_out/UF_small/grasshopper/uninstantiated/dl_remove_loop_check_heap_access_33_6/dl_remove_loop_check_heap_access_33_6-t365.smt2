...
(assert (not (not (in$0 (read$0 next$0 d_init$0) Alloc$0))))
(assert (not (in$0 null$0 Alloc$0)))
(assert (or (not (= (not (in$0 null$0 Alloc$0)) (not (in$0 (read$0 next$0 d_init$0) Alloc$0)))) (not (not (in$0 null$0 Alloc$0))) (not (in$0 (read$0 next$0 d_init$0) Alloc$0))))
(assert (= (not (in$0 null$0 Alloc$0)) (not (in$0 (read$0 next$0 d_init$0) Alloc$0))))
(check-sat)
(exit)
