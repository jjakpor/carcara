...
(assert (not (= (or (not (Btwn$0 next$0 (read$0 next$0 lst$0) lst$0 (read$0 next$0 lst$0))) (= (read$0 next$0 lst$0) lst$0)) (or (not (Btwn$0 next$0 (read$0 next$0 lst$0) lst$0 (read$0 next$0 lst$0))) (= lst$0 (read$0 next$0 lst$0))))))
(assert (= (not (Btwn$0 next$0 (read$0 next$0 lst$0) lst$0 (read$0 next$0 lst$0))) (not (Btwn$0 next$0 (read$0 next$0 lst$0) lst$0 (read$0 next$0 lst$0)))))
(assert (= (= (read$0 next$0 lst$0) lst$0) (= lst$0 (read$0 next$0 lst$0))))
(check-sat)
(exit)
