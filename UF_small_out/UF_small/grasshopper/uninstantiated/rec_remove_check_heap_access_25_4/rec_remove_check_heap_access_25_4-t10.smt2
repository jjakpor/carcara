...
(assert (not (not (forall ((?f FldLoc) (?x Loc)) (Btwn$0 ?f ?x (read$0 ?f ?x) (read$0 ?f ?x))))))
(assert (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) (read$0 next$0 lst$0))))
(assert (or (not (forall ((?f FldLoc) (?x Loc)) (Btwn$0 ?f ?x (read$0 ?f ?x) (read$0 ?f ?x)))) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) (read$0 next$0 lst$0))))
(check-sat)
(exit)
