...
(assert (not (= (union$0 (intersection$0 Alloc_1$0 sk_?X_10$0) (setminus$0 Alloc_1$0 Alloc$0)) (union$0 (intersection$0 Alloc_1$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0)) (setminus$0 Alloc_1$0 Alloc$0)))))
(assert (= (setminus$0 Alloc_1$0 Alloc$0) (setminus$0 Alloc_1$0 Alloc$0)))
(assert (= (intersection$0 Alloc_1$0 sk_?X_10$0) (intersection$0 Alloc_1$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0))))
(check-sat)
(exit)
