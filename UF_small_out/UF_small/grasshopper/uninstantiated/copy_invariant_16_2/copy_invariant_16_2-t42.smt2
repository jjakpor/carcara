...
(assert (not (= (intersection$0 sk_?X_5$0 sk_?X_4$0) (intersection$0 (lseg_domain$0 next$0 lst$0 lst$0) (lseg_domain$0 next$0 lst$0 cp_2$0)))))
(assert (= sk_?X_4$0 (lseg_domain$0 next$0 lst$0 cp_2$0)))
