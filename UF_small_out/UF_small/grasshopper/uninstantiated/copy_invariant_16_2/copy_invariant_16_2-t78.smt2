...
(assert (not (= (not (lseg_struct$0 sk_?X_4$0 next$0 curr_2$0 null$0)) (not (lseg_struct$0 (lseg_domain$0 next$0 lst$0 cp_2$0) next$0 lst$0 cp_2$0)))))
(assert (= (lseg_struct$0 sk_?X_4$0 next$0 curr_2$0 null$0) (lseg_struct$0 (lseg_domain$0 next$0 lst$0 cp_2$0) next$0 lst$0 cp_2$0)))
(check-sat)
(exit)
