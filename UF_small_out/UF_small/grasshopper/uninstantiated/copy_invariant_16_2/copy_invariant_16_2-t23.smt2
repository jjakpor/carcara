...
(assert (not (= sk_?X_4$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(assert (= sk_?X_4$0 (lseg_domain$0 next$0 curr_2$0 cp_2$0)))
(assert (= (lseg_domain$0 next$0 curr_2$0 cp_2$0) (lseg_domain$0 next$0 lst$0 cp_2$0)))
(check-sat)
(exit)
