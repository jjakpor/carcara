...
(assert (not (= FP$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(assert (or (not (= (= FP$0 sk_?X$0) (= FP$0 (lseg_domain$0 next$0 lst$0 cp_2$0)))) (not (= FP$0 sk_?X$0)) (= FP$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(assert (= (= FP$0 sk_?X$0) (= FP$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(assert (= FP$0 sk_?X$0))
(check-sat)
(exit)
