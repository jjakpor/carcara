...
(assert (not (= (not (in$0 sk_?e$0 FP$0)) (not (in$0 sk_?e$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))))
(assert (= (in$0 sk_?e$0 FP$0) (in$0 sk_?e$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(check-sat)
(exit)
