...
(assert (not (= (lseg_struct$0 sk_?X$0 next$0 lst$0 null$0) (lseg_struct$0 (lseg_domain$0 next$0 lst$0 cp_2$0) next$0 lst$0 cp_2$0))))
(assert (= next$0 next$0))
(assert (= null$0 cp_2$0))
(assert (= lst$0 lst$0))
(assert (= sk_?X$0 (lseg_domain$0 next$0 lst$0 cp_2$0)))
(check-sat)
(exit)
