...
(declare-fun x$0 () Loc)
(assert (not (= sk_?X_2$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0))))
(assert (= sk_?X_2$0 (union$0 sk_?X_5$0 sk_?X_3$0)))
(assert (= (union$0 sk_?X_5$0 sk_?X_3$0) (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0)))
(check-sat)
(exit)
