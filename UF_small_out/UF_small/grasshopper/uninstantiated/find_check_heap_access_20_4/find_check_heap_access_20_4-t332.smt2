...
(declare-fun x$0 () Loc)
(assert (not (= (forall ((BOUND_VARIABLE_973 Loc)) (or (not (= root_x$0 BOUND_VARIABLE_973)) (and (or (= root_x$0 BOUND_VARIABLE_973) (not (Btwn$0 next$0 x$0 BOUND_VARIABLE_973 root_x$0))) (not (in$0 BOUND_VARIABLE_973 (lseg_set_domain$0 next$0 x$0 root_x$0)))))) (not (in$0 root_x$0 (lseg_set_domain$0 next$0 x$0 root_x$0))))))
(assert (= (forall ((BOUND_VARIABLE_973 Loc)) (or (not (= root_x$0 BOUND_VARIABLE_973)) (and (or (= root_x$0 BOUND_VARIABLE_973) (not (Btwn$0 next$0 x$0 BOUND_VARIABLE_973 root_x$0))) (not (in$0 BOUND_VARIABLE_973 (lseg_set_domain$0 next$0 x$0 root_x$0)))))) (or (not (= root_x$0 root_x$0)) (and (or (= root_x$0 root_x$0) (not (Btwn$0 next$0 x$0 root_x$0 root_x$0))) (not (in$0 root_x$0 (lseg_set_domain$0 next$0 x$0 root_x$0)))))))
