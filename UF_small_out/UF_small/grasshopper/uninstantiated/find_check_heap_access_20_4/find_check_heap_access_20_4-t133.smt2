...
(declare-fun x$0 () Loc)
(assert (not (= (= sk_?X_17$0 (union$0 sk_?X_14$0 sk_?X_16$0)) (= sk_?X_19$0 (union$0 (lseg_set_X$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0))))))
(assert (= sk_?X_17$0 sk_?X_19$0))
(assert (= (union$0 sk_?X_14$0 sk_?X_16$0) (union$0 (lseg_set_X$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0))))
(check-sat)
(exit)
