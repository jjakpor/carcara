...
(assert (not (not (and (= end1$0 (read$0 next$0 end1$0)) (= start1$0 (read$0 next$0 end1$0))))))
(assert (or (= start1$0 (read$0 next$0 end1$0)) (not (and (= end1$0 (read$0 next$0 end1$0)) (= start1$0 (read$0 next$0 end1$0))))))
(assert (not (= start1$0 (read$0 next$0 end1$0))))
(check-sat)
(exit)
