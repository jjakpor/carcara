...
(assert (not (= (= FP$0 sk_?X_8$0) (= FP$0 (union$0 sk_?X_10$0 (dlseg_domain$0 next$0 prev$0 start2$0 null$0 null$0 end2$0))))))
(assert (= FP$0 FP$0))
(assert (= sk_?X_8$0 (union$0 sk_?X_10$0 (dlseg_domain$0 next$0 prev$0 start2$0 null$0 null$0 end2$0))))
(check-sat)
(exit)
