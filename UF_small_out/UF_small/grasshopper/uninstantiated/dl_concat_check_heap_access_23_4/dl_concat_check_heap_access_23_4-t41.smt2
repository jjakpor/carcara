...
(assert (not (= (not (= null$0 start1$0)) (not (= start1$0 (read$0 next$0 end1$0))))))
(assert (= (not (= null$0 start1$0)) (not (= (read$0 next$0 end1$0) start1$0))))
(assert (= (not (= (read$0 next$0 end1$0) start1$0)) (not (= start1$0 (read$0 next$0 end1$0)))))
(check-sat)
(exit)
