...
(assert (not (= (and (= null$0 end1$0) (= null$0 start1$0)) (and (= (read$0 next$0 end1$0) end1$0) (= (read$0 next$0 end1$0) start1$0)))))
(assert (= (= null$0 start1$0) (= (read$0 next$0 end1$0) start1$0)))
(assert (= (= null$0 end1$0) (= (read$0 next$0 end1$0) end1$0)))
(check-sat)
(exit)
