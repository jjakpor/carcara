...
(assert (not (= (and (= null$0 end1$0) (= start1$0 null$0)) (and (= null$0 end1$0) (= null$0 start1$0)))))
(assert (= (= start1$0 null$0) (= null$0 start1$0)))
(assert (= (= null$0 end1$0) (= null$0 end1$0)))
(check-sat)
(exit)
