...
(assert (not (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0)))
(assert (not (not (and (Btwn$0 next$0 lst$0 cp_2$0 cp_2$0) (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0)))))
(assert (or (not (and (Btwn$0 next$0 lst$0 cp_2$0 cp_2$0) (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0))) (Btwn$0 next$0 cp_2$0 cp_2$0 cp_2$0)))
(check-sat)
(exit)
