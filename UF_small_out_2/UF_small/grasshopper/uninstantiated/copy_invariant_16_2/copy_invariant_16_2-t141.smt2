...
(assert (not (= (or (= null$0 null$0) (not (Btwn$0 next$0 cp_2$0 null$0 null$0))) (or true (not (Btwn$0 next$0 cp_2$0 null$0 null$0))))))
(assert (= (= null$0 null$0) true))
(assert (= (not (Btwn$0 next$0 cp_2$0 null$0 null$0)) (not (Btwn$0 next$0 cp_2$0 null$0 null$0))))
(check-sat)
(exit)
