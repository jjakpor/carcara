...
(assert (not (not (= (= sk_?X_5$0 (lseg_domain$0 next$0 lst$0 curr_2$0)) (= sk_?X_5$0 (lseg_domain$0 next$0 lst$0 lst$0))))))
(assert (not (not (= sk_?X_5$0 (lseg_domain$0 next$0 lst$0 curr_2$0)))))
