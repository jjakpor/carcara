...
(declare-fun x$0 () Loc)
(assert (not (= (not (in$0 x$0 FP$0)) (not (in$0 x$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) (setenum$0 root_x$0)))))))
(assert (= (in$0 x$0 FP$0) (in$0 x$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) (setenum$0 root_x$0)))))
(check-sat)
(exit)
