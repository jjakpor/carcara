...
(declare-fun x$0 () Loc)
(assert (not (= (or (= root_x$0 root_x$0) (not (Btwn$0 next$0 x$0 root_x$0 root_x$0))) true)))
(assert (= (or (= root_x$0 root_x$0) (not (Btwn$0 next$0 x$0 root_x$0 root_x$0))) (or true (not (Btwn$0 next$0 x$0 root_x$0 root_x$0)))))
(assert (= (or true (not (Btwn$0 next$0 x$0 root_x$0 root_x$0))) true))
(check-sat)
(exit)
