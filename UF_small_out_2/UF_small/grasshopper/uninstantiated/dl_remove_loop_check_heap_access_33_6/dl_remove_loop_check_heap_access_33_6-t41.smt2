...
(assert (not (= (not (= null$0 curr_init$0)) (not (= prv_5$0 (read$0 next$0 d_init$0))))))
(assert (= (not (= null$0 curr_init$0)) (not (= (read$0 next$0 d_init$0) prv_5$0))))
(assert (= (not (= (read$0 next$0 d_init$0) prv_5$0)) (not (= prv_5$0 (read$0 next$0 d_init$0)))))
(check-sat)
(exit)
