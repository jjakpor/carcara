...
(assert (not (= (not (dlseg_struct$0 sk_?X_76$0 next$0 prev$0 curr_init$0 prv_init$0 null$0 d_init$0)) (not (dlseg_struct$0 sk_?X_76$0 next$0 prev$0 curr_init$0 prv_init$0 null$0 d_init$0)))))
(check-sat)
(exit)
