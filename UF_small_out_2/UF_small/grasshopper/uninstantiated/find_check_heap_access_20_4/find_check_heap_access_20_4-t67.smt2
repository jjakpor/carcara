...
(declare-fun x$0 () Loc)
(assert (not (not (= (or (Btwn$0 next$0 x$0 root_x$0 root_x$0) (not (lseg_set_struct$0 sk_?X_23$0 next$0 x$0 root_x$0 X$0))) (or (Btwn$0 next$0 x$0 root_x$0 root_x$0) (not (lseg_set_struct$0 (lseg_set_domain$0 next$0 x$0 root_x$0) next$0 x$0 root_x$0 (lseg_set_X$0 next$0 x$0 root_x$0))))))))
(assert (not (not (or (Btwn$0 next$0 x$0 root_x$0 root_x$0) (not (lseg_set_struct$0 sk_?X_23$0 next$0 x$0 root_x$0 X$0))))))
