...
(declare-fun x$0 () Loc)
(assert (not (= (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= x$0 root_x$0)) (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0)))))
(assert (= (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (not (Btwn$0 next$0 x$0 root_x$0 x$0))))
(assert (= (= x$0 root_x$0) (= root_x$0 x$0)))
(check-sat)
(exit)
