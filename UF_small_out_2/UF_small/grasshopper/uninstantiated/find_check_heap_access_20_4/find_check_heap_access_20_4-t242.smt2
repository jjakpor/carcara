...
(declare-fun x$0 () Loc)
(assert (not (= (not (in$0 root_x$0 (lseg_set_X$0 next$0 n_5$0 root_x$0))) (not (in$0 root_x$0 (lseg_set_X$0 next$0 (read$0 next$0 x$0) root_x$0))))))
(assert (= (in$0 root_x$0 (lseg_set_X$0 next$0 n_5$0 root_x$0)) (in$0 root_x$0 (lseg_set_X$0 next$0 (read$0 next$0 x$0) root_x$0))))
(check-sat)
(exit)
