...
(declare-fun x$0 () Loc)
(assert (not (not (= (read$0 next$0 x$0) (read$0 next$0 root_x$0)))))
(assert (not (= n_5$0 null$0)))
(assert (or (not (= (not (= n_5$0 null$0)) (not (= (read$0 next$0 x$0) (read$0 next$0 root_x$0))))) (not (not (= n_5$0 null$0))) (not (= (read$0 next$0 x$0) (read$0 next$0 root_x$0)))))
(assert (= (not (= n_5$0 null$0)) (not (= (read$0 next$0 x$0) (read$0 next$0 root_x$0)))))
(check-sat)
(exit)
