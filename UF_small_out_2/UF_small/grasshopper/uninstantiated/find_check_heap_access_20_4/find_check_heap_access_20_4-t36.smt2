...
(declare-fun x$0 () Loc)
(assert (not (= (= (read$0 next_2$0 root_x$0) null$0) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0)))))
(assert (= (= (read$0 next_2$0 root_x$0) null$0) (= null$0 (read$0 next_2$0 root_x$0))))
(assert (= (= null$0 (read$0 next_2$0 root_x$0)) (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))))
(check-sat)
(exit)
