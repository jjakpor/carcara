...
(assert (or (not (Btwn$0 next$0 x$0 root_x$0 root_x$0)) (Btwn$0 next$0 x$0 x$0 root_x$0) (Btwn$0 next$0 x$0 root_x$0 x$0) (not (Btwn$0 next$0 x$0 x$0 x$0)) (not (or (not (Btwn$0 next$0 x$0 root_x$0 root_x$0)) (not (Btwn$0 next$0 x$0 x$0 x$0)) (Btwn$0 next$0 x$0 root_x$0 x$0) (Btwn$0 next$0 x$0 x$0 root_x$0)))))
(assert (Btwn$0 next$0 x$0 root_x$0 root_x$0))
(assert (not (Btwn$0 next$0 x$0 x$0 root_x$0)))
(assert (Btwn$0 next$0 x$0 x$0 x$0))
(assert (or (not (Btwn$0 next$0 x$0 root_x$0 root_x$0)) (not (Btwn$0 next$0 x$0 x$0 x$0)) (Btwn$0 next$0 x$0 root_x$0 x$0) (Btwn$0 next$0 x$0 x$0 root_x$0)))
(check-sat)
(exit)
