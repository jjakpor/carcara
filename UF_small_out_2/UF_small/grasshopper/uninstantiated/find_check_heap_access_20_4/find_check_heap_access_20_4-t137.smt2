...
(declare-fun x$0 () Loc)
(assert (not (not (= (= sk_?X_27$0 (lseg_set_domain$0 next$0 n_5$0 root_x$0)) (= sk_?X_27$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0))))))
(assert (not (not (= sk_?X_27$0 (lseg_set_domain$0 next$0 n_5$0 root_x$0)))))
