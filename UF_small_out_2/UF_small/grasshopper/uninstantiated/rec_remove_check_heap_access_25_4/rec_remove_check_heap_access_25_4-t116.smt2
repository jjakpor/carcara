...
(assert (not (= (forall ((BOUND_VARIABLE_740 Loc)) (or (not (= null$0 BOUND_VARIABLE_740)) (and (or (= null$0 BOUND_VARIABLE_740) (not (Btwn$0 next$0 n1_2$0 BOUND_VARIABLE_740 null$0))) (not (in$0 BOUND_VARIABLE_740 (lseg_domain$0 next$0 n1_2$0 null$0)))))) (or (not (= null$0 null$0)) (and (or (= null$0 null$0) (not (Btwn$0 next$0 n1_2$0 null$0 null$0))) (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0))))))))
(check-sat)
(exit)
