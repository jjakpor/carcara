...
(assert (not (not (and (Btwn$0 next$0 lst$0 lst$0 null$0) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0)))))
(assert (or (not (and (Btwn$0 next$0 lst$0 lst$0 null$0) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0))) (Btwn$0 next$0 lst$0 lst$0 null$0)))
(check-sat)
(exit)
