...
(assert (not (= (intersection$0 Alloc_1$0 sk_?X_10$0) (intersection$0 Alloc_1$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0)))))
(assert (= Alloc_1$0 Alloc_1$0))
(assert (= sk_?X_10$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0)))
(check-sat)
(exit)
