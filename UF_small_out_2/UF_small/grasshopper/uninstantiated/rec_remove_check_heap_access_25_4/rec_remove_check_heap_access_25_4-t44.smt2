...
(assert (not (not (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?y)) (= ?x ?y) (Btwn$0 ?f ?x (read$0 ?f ?x) ?y))))))
(assert (not (or (not (Btwn$0 next$0 lst$0 null$0 null$0)) (= null$0 lst$0) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0))))
(assert (=> (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?y)) (= ?x ?y) (Btwn$0 ?f ?x (read$0 ?f ?x) ?y))) (or (not (Btwn$0 next$0 lst$0 null$0 null$0)) (= null$0 lst$0) (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) null$0))))
(check-sat)
(exit)
