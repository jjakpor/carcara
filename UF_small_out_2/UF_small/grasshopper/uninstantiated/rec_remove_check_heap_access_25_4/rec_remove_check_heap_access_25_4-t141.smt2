...
(assert (not (= (not (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0))) (not (in$0 null$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0))))))
(assert (= (in$0 null$0 (lseg_domain$0 next$0 n1_2$0 null$0)) (in$0 null$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0))))
(check-sat)
(exit)
