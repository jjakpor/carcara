...
(assert (not (= (= sk_?X_10$0 (lseg_domain$0 next$0 n1_2$0 null$0)) (= sk_?X_10$0 (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0)))))
(assert (= (lseg_domain$0 next$0 n1_2$0 null$0) (lseg_domain$0 next$0 (read$0 next$0 lst$0) null$0)))
(assert (= sk_?X_10$0 sk_?X_10$0))
(check-sat)
(exit)
