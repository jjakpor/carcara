...
(assert (not (= (and (= null$0 curr_init$0) (= d_init$0 prv_init$0)) (and (= (read$0 next$0 d_init$0) prv_5$0) (= d_init$0 (read$0 prev$0 prv_5$0))))))
(assert (= (= null$0 curr_init$0) (= (read$0 next$0 d_init$0) prv_5$0)))
(assert (= (= d_init$0 prv_init$0) (= d_init$0 (read$0 prev$0 prv_5$0))))
(check-sat)
(exit)
