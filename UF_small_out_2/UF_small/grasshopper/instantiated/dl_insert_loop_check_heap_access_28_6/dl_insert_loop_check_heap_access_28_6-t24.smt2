...
(assert (not (= (and (= (read$0 next$0 d_init$0) null$0) (= (read$0 prev$0 curr_init$0) prv_init$0) (in$0 d_init$0 sk_?X_92$0)) (and (= null$0 (read$0 next$0 d_init$0)) (= prv_init$0 (read$0 prev$0 curr_init$0)) (in$0 d_init$0 sk_?X_92$0)))))
(assert (= (= (read$0 next$0 d_init$0) null$0) (= null$0 (read$0 next$0 d_init$0))))
(assert (= (= (read$0 prev$0 curr_init$0) prv_init$0) (= prv_init$0 (read$0 prev$0 curr_init$0))))
(assert (= (in$0 d_init$0 sk_?X_92$0) (in$0 d_init$0 sk_?X_92$0)))
(check-sat)
(exit)
