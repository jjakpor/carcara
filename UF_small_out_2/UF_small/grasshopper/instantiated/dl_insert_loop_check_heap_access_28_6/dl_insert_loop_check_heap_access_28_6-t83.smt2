...
(assert (not (= (and (Btwn$0 next$0 curr_init$0 null$0 null$0) (or (and (= null$0 (read$0 next$0 d_init$0)) (= prv_init$0 (read$0 prev$0 curr_init$0)) (in$0 d_init$0 sk_?X_92$0)) (and (= null$0 curr_init$0) (= d_init$0 prv_init$0))) Axiom_33$0) (and (Btwn$0 next$0 prv_5$0 (read$0 next$0 d_init$0) (read$0 next$0 d_init$0)) (or (and (= (read$0 next$0 d_init$0) (read$0 next$0 d_init$0)) (= (read$0 prev$0 prv_5$0) (read$0 prev$0 prv_5$0)) (in$0 d_init$0 (dlseg_domain$0 next$0 prev$0 prv_5$0 (read$0 prev$0 prv_5$0) (read$0 next$0 d_init$0) d_init$0))) (and (= (read$0 next$0 d_init$0) prv_5$0) (= d_init$0 (read$0 prev$0 prv_5$0)))) true))))
(assert (= (Btwn$0 next$0 curr_init$0 null$0 null$0) (Btwn$0 next$0 prv_5$0 (read$0 next$0 d_init$0) (read$0 next$0 d_init$0))))
(assert (= (or (and (= null$0 (read$0 next$0 d_init$0)) (= prv_init$0 (read$0 prev$0 curr_init$0)) (in$0 d_init$0 sk_?X_92$0)) (and (= null$0 curr_init$0) (= d_init$0 prv_init$0))) (or (and (= (read$0 next$0 d_init$0) (read$0 next$0 d_init$0)) (= (read$0 prev$0 prv_5$0) (read$0 prev$0 prv_5$0)) (in$0 d_init$0 (dlseg_domain$0 next$0 prev$0 prv_5$0 (read$0 prev$0 prv_5$0) (read$0 next$0 d_init$0) d_init$0))) (and (= (read$0 next$0 d_init$0) prv_5$0) (= d_init$0 (read$0 prev$0 prv_5$0))))))
(assert (= Axiom_33$0 true))
(check-sat)
(exit)
