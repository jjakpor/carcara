...
(declare-fun a () Set)
(declare-fun b () Set)
(assert (not (not (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) (intersection a b)))))
(assert (not (and (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) a) (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) b))))
(assert (not (not (= (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) (intersection a b)) (and (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) a) (member (choice ((?x Elem)) (not (or (not (member ?x (intersection a b))) (member ?x (intersection b a))))) b))))))
