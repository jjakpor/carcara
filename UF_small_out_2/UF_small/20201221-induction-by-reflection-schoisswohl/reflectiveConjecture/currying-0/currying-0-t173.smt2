...
(assert (or (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (models empty (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))) (not (or (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (models empty (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))))))))
(assert (not (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))))
(assert (or (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (models empty (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))))))
(check-sat)
(exit)
