...
(assert (not (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))
(assert (not (not (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR)))))))
(assert (not (not (= (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))) (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR))))))))
(assert (or (not (= (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))) (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR)))))) (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))) (not (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR)))))))
(check-sat)
(exit)
