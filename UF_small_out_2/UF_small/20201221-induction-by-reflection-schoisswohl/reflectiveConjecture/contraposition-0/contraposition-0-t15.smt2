...
(assert (not (not (models empty (notR (notR (qR bR)))))))
(assert (not (not (models empty (notR (qR bR))))))
(assert (not (not (= (models empty (notR (notR (qR bR)))) (not (models empty (notR (qR bR))))))))
