...
(assert (not (not (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))))))
(assert (not (not (= (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (not (models empty (notR (orR (notR (pR aR)) (qR bR)))))))))
(assert (or (not (= (models empty (notR (notR (orR (notR (pR aR)) (qR bR))))) (not (models empty (notR (orR (notR (pR aR)) (qR bR))))))) (not (models empty (notR (notR (orR (notR (pR aR)) (qR bR)))))) (not (models empty (notR (orR (notR (pR aR)) (qR bR)))))))
(check-sat)
(exit)
