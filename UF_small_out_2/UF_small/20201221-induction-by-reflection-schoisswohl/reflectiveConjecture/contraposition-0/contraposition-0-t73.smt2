...
(assert (not (= (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))) (not (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))))
(assert (or (not (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))) (= (models empty (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))) (not (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))))
(check-sat)
(exit)
