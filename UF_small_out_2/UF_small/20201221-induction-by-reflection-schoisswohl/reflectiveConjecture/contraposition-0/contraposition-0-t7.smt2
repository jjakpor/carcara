...
(assert (not (models empty (orR (notR (notR (qR bR))) (notR (pR aR))))))
(assert (not (not (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR)))))))
(assert (not (not (= (models empty (orR (notR (notR (qR bR))) (notR (pR aR)))) (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR))))))))
(assert (or (not (= (models empty (orR (notR (notR (qR bR))) (notR (pR aR)))) (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR)))))) (models empty (orR (notR (notR (qR bR))) (notR (pR aR)))) (not (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR)))))))
(check-sat)
(exit)
