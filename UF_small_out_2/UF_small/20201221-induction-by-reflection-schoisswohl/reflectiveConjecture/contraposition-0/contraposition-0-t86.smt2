...
(assert (not (= (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (qR bR)))) (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))) (models empty (notR (orR (notR (notR (orR (notR (pR aR)) (qR bR)))) (notR (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))))))
(check-sat)
(exit)
