...
(assert (or (models empty (orR (notR (notR (qR bR))) (notR (pR aR)))) (not (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR))))) (not (= (models empty (orR (notR (notR (qR bR))) (notR (pR aR)))) (or (models empty (notR (notR (qR bR)))) (models empty (notR (pR aR))))))))
