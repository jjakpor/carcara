...
(assert (or (not (models empty (qR bR))) (not (models empty (notR (qR bR)))) (not (= (not (models empty (qR bR))) (models empty (notR (qR bR)))))))
(assert (= (not (models empty (qR bR))) (models empty (notR (qR bR)))))
(assert (models empty (qR bR)))
(assert (models empty (notR (qR bR))))
(check-sat)
(exit)
