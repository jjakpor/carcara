...
(assert (not (= (not (= (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) (inj_nat v0_nat)) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) v0_nat))) (not (= (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) (inj_nat v0_nat)) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) v0_nat))))))
(check-sat)
(exit)
