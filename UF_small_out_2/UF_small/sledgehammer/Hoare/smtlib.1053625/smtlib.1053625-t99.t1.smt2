...
(declare-fun f25 () S8)
(declare-fun f26 () S6)
(assert (not (= (forall ((?v0 S8) (?v1 S2) (?v2 S2)) (=> (= (f3 (f4 (f11 (f12 f13 (f14 ?v0))) ?v1) ?v2) f1) (= (f3 (f4 (f11 (f15 f16 ?v0)) ?v1) ?v2) f1))) (forall ((?v0 S8) (?v1 S2) (?v2 S2)) (=> (= f1 (f3 (f4 (f11 (f12 f13 (f14 ?v0))) ?v1) ?v2)) (= f1 (f3 (f4 (f11 (f15 f16 ?v0)) ?v1) ?v2)))))))
(check-sat)
(exit)
