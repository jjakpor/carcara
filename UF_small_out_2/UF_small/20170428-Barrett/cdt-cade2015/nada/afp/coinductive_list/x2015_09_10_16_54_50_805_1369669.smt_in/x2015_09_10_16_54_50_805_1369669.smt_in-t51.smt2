...
(assert (not (= (or thesis$ (forall ((?v0 A_list$)) (not (= xs$ (fun_app$g llist_of$ ?v0))))) (or false (forall ((?v0 A_list$)) (not (= xs$ (fun_app$g llist_of$ ?v0))))))))
(assert (= thesis$ false))
(assert (= (forall ((?v0 A_list$)) (not (= xs$ (fun_app$g llist_of$ ?v0)))) (forall ((?v0 A_list$)) (not (= xs$ (fun_app$g llist_of$ ?v0))))))
(check-sat)
(exit)
