...
(assert (not (not (= (forall ((?v0 A$) (?v1 A$)) (= (fun_app$bk (fun_app$bu uu$ ?v0) ?v1) false)) (forall ((?v0 A$) (?v1 A$)) (not (fun_app$bk (fun_app$bu uu$ ?v0) ?v1)))))))
(assert (not (not (forall ((?v0 A$) (?v1 A$)) (= (fun_app$bk (fun_app$bu uu$ ?v0) ?v1) false)))))
