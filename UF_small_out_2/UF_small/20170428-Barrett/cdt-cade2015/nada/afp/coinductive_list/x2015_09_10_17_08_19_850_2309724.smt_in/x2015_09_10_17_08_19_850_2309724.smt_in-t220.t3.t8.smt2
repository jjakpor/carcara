...
(assert (not (= (exists ((?v3 A$) (?v4 A$) (?v5 A_llist$) (?v6 A_llist$)) (and (= ?v1 (lCons$ ?v3 ?v5)) (and (= ?v2 (lCons$ ?v4 ?v6)) (fun_app$bk (fun_app$bu ?v0 ?v3) ?v4)))) (exists ((?v3 A$) (?v4 A$) (?v5 A_llist$) (?v6 A_llist$)) (and (= ?v1 (lCons$ ?v3 ?v5)) (= ?v2 (lCons$ ?v4 ?v6)) (fun_app$bk (fun_app$bu ?v0 ?v3) ?v4))))))
(check-sat)
(exit)
