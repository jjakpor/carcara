...
(assert (= (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$m (fun_app$n ?v0 ?v1) ?v2) (forall ((?v3 A_llist$) (?v4 A_llist$)) (=> (fun_app$m (fun_app$n ?v0 ?v3) ?v4) (or (exists ((?v5 A_llist$)) (and (= ?v3 lNil$) (= ?v4 ?v5))) (exists ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (and (= ?v3 (lCons$ ?v7 ?v5)) (and (= ?v4 (lCons$ ?v7 ?v6)) (or (fun_app$m (fun_app$n ?v0 ?v5) ?v6) (fun_app$m (fun_app$n lprefix$ ?v5) ?v6))))))))) (fun_app$m (fun_app$n lprefix$ ?v1) ?v2))) (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$m (fun_app$n ?v0 ?v1) ?v2) (forall ((?v3 A_llist$) (?v4 A_llist$)) (or (not (fun_app$m (fun_app$n ?v0 ?v3) ?v4)) (= lNil$ ?v3) (not (forall ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (or (not (= ?v3 (lCons$ ?v7 ?v5))) (not (= ?v4 (lCons$ ?v7 ?v6))) (and (not (fun_app$m (fun_app$n ?v0 ?v5) ?v6)) (not (fun_app$m (fun_app$n lprefix$ ?v5) ?v6))))))))) (fun_app$m (fun_app$n lprefix$ ?v1) ?v2)))))
(assert (= (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$m (fun_app$n ?v0 ?v1) ?v2) (forall ((?v3 A_llist$) (?v4 A_llist$)) (or (not (fun_app$m (fun_app$n ?v0 ?v3) ?v4)) (= lNil$ ?v3) (not (forall ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (or (not (= ?v3 (lCons$ ?v7 ?v5))) (not (= ?v4 (lCons$ ?v7 ?v6))) (and (not (fun_app$m (fun_app$n ?v0 ?v5) ?v6)) (not (fun_app$m (fun_app$n lprefix$ ?v5) ?v6))))))))) (fun_app$m (fun_app$n lprefix$ ?v1) ?v2))) (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (or (not (fun_app$m (fun_app$n ?v0 ?v1) ?v2)) (not (forall ((?v3 A_llist$) (?v4 A_llist$)) (or (not (fun_app$m (fun_app$n ?v0 ?v3) ?v4)) (= lNil$ ?v3) (not (forall ((?v5 A_llist$) (?v6 A_llist$) (?v7 A$)) (or (not (= ?v3 (lCons$ ?v7 ?v5))) (not (= ?v4 (lCons$ ?v7 ?v6))) (and (not (fun_app$m (fun_app$n ?v0 ?v5) ?v6)) (not (fun_app$m (fun_app$n lprefix$ ?v5) ?v6))))))))) (fun_app$m (fun_app$n lprefix$ ?v1) ?v2)))))
(check-sat)
(exit)
