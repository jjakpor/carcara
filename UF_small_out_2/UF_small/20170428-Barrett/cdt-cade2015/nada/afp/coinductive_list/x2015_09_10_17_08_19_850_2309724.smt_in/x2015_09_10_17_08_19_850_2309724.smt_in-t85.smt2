...
(assert (not (= (not (fun_app$m (fun_app$n lprefix$ xs$) ys$)) (not (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$)))))
(assert (= (fun_app$m (fun_app$n lprefix$ xs$) ys$) (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$)))
(check-sat)
(exit)
