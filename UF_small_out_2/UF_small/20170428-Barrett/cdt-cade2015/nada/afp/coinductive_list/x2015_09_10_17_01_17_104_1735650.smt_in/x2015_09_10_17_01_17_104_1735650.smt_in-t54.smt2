...
(assert (not (= (iterates$ f$ (fun_app$a (fun_app$b (fun_app$c compow$ n$) f$) x$)) (iterates$ f$ (fun_app$a (fun_app$b (fun_app$c funpow$ n$) f$) x$)))))
(assert (= f$ f$))
(assert (= (fun_app$a (fun_app$b (fun_app$c compow$ n$) f$) x$) (fun_app$a (fun_app$b (fun_app$c funpow$ n$) f$) x$)))
(check-sat)
(exit)
