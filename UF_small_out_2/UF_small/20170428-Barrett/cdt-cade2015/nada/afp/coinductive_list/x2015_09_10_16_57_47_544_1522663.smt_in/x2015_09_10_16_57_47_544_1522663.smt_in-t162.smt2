...
(assert (not (not (forall ((?v0 A$)) (= (fun_app$e uu$ ?v0) (ldropn$ n$))))))
(assert (not (= (ldropn$ n$) (fun_app$e uu$ (lhd$ xs$)))))
(assert (=> (forall ((?v0 A$)) (= (fun_app$e uu$ ?v0) (ldropn$ n$))) (= (ldropn$ n$) (fun_app$e uu$ (lhd$ xs$)))))
(check-sat)
(exit)
