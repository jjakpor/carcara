...
(assert (not (= (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)) (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$)))))
(assert (= (llength$ us$) (llength$a xs$)))
(assert (= (less_eq$ (llength$a xs$)) (less_eq$ (llength$ us$))))
(check-sat)
(exit)
