...
(assert (or (= xs$ (ltake$ (llength$ us$) xs$)) (not (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$))) (not (or (not (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$))) (= xs$ (ltake$ (llength$ us$) xs$))))))
(assert (fun_app$ (less_eq$ (llength$a xs$)) (llength$ us$)))
(check-sat)
(exit)
