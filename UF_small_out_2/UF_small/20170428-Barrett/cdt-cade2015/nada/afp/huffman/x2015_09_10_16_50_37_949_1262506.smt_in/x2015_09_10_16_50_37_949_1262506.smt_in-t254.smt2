...
(assert (not (or (= a$ d$) (= b$ c$))))
(assert (or (not (= (or (not (not (= a$ d$))) (not (not (= b$ c$)))) (or (= a$ d$) (= b$ c$)))) (not (or (not (not (= a$ d$))) (not (not (= b$ c$))))) (or (= a$ d$) (= b$ c$))))
(assert (= (or (not (not (= a$ d$))) (not (not (= b$ c$)))) (or (= a$ d$) (= b$ c$))))
(assert (or (not (not (= a$ d$))) (not (not (= b$ c$)))))
(check-sat)
(exit)
