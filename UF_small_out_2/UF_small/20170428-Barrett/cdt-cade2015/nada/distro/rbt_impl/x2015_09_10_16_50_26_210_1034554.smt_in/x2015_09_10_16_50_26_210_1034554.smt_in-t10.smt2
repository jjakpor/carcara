...
(assert (or (fun_app$f (rbt_greater$ less$ k$) t2$) (not (and (fun_app$f (rbt_less$ less$ k$) t1$) (fun_app$f (rbt_greater$ less$ k$) t2$) (fun_app$f (rbt_sorted$ less$) t1$) (fun_app$f (rbt_sorted$ less$) t2$)))))
(check-sat)
(exit)
