...
(assert (or (not y$v3_1517448504_183_op) (and y$a_r4 y$v3_1517448504_182_op)))
(assert (not (and y$a_r4 y$v3_1517448504_182_op)))
(assert (not (not y$v3_1517448504_183_op)))
(check-sat)
(exit)
