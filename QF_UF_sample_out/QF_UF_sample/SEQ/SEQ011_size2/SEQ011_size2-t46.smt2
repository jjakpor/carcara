...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (or (not (= (or (= (f7 c_1) c_0) (= (f7 c_1) c_1)) (or (= c_0 (f7 c_1)) (= c_1 (f7 c_1))))) (not (or (= (f7 c_1) c_0) (= (f7 c_1) c_1))) (or (= c_0 (f7 c_1)) (= c_1 (f7 c_1)))))
(assert (= (or (= (f7 c_1) c_0) (= (f7 c_1) c_1)) (or (= c_0 (f7 c_1)) (= c_1 (f7 c_1)))))
(assert (or (= (f7 c_1) c_0) (= (f7 c_1) c_1)))
(assert (not (or (= c_0 (f7 c_1)) (= c_1 (f7 c_1)))))
(check-sat)
(exit)
