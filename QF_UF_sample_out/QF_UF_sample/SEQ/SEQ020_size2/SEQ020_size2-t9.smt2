...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (= (= (not (not (p1 (f7 c_1) c_1))) (p1 (f7 c_1) c_1)) (= (p1 (f7 c_1) c_1) (not (not (p1 (f7 c_1) c_1))))))
(assert (= (= (p1 (f7 c_1) c_1) (not (not (p1 (f7 c_1) c_1)))) true))
(assert (not (= (= (not (not (p1 (f7 c_1) c_1))) (p1 (f7 c_1) c_1)) true)))
(check-sat)
(exit)
