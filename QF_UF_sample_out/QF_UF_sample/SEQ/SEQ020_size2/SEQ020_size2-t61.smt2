...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (= (not (not (= (f6 c_1) (f5 c_1)))) (= (f6 c_1) (f5 c_1))))
(assert (= (not (= c_0 (f6 c_1))) (not (= c_0 (f6 c_1)))))
(assert (= (not (= c_0 (f5 c_1))) (not (= c_0 (f5 c_1)))))
(assert (not (= (or (not (not (= (f6 c_1) (f5 c_1)))) (not (= c_0 (f6 c_1))) (not (= c_0 (f5 c_1)))) (or (= (f6 c_1) (f5 c_1)) (not (= c_0 (f6 c_1))) (not (= c_0 (f5 c_1)))))))
(check-sat)
(exit)
