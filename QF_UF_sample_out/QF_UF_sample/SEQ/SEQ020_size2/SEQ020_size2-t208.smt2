...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (or (not (= (or (= (f6 c_0) c_0) (= (f6 c_0) c_1)) (or (= c_0 (f6 c_0)) (= c_1 (f6 c_0))))) (not (or (= (f6 c_0) c_0) (= (f6 c_0) c_1))) (or (= c_0 (f6 c_0)) (= c_1 (f6 c_0)))))
(assert (= (or (= (f6 c_0) c_0) (= (f6 c_0) c_1)) (or (= c_0 (f6 c_0)) (= c_1 (f6 c_0)))))
(assert (or (= (f6 c_0) c_0) (= (f6 c_0) c_1)))
(assert (not (or (= c_0 (f6 c_0)) (= c_1 (f6 c_0)))))
(check-sat)
(exit)
