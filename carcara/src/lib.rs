...
mod tests {
    ...
    fn test_slice() {
        ...
        let expected_t4_d_0 = "(assume slice_assume_false false)
...
";
        ...
        let expected_t3_d_0 = "(assume slice_assume_false false)
(anchor :step t3)
(assume t3.a0 (not a))
...
";
        ...
        let expected_t3_t1_d_0 = "(assume slice_assume_false false)
(anchor :step t3)
(assume t3.a0 (not a))
...
";
        ...
        // Greater distances
        let expected_t5_d_1 = "(assume slice_assume_false false)
(assume a0 a)
...
";
        ...
        let expected_t5_d_2 = "(assume slice_assume_false false)
(assume a0 a)
(step t0 (cl a b) :rule hole :premises (a0))
(step t2 (cl a b (not a)) :rule hole :premises (t0))
(anchor :step t3)
