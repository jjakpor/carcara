...
(assert (not (= (= infinity$ (llength$ us$)) (= (llength$ us$) (llength$a xs$)))))
(assert (= (= infinity$ (llength$ us$)) (= (llength$a xs$) (llength$ us$))))
(assert (= (= (llength$a xs$) (llength$ us$)) (= (llength$ us$) (llength$a xs$))))
(check-sat)
(exit)
