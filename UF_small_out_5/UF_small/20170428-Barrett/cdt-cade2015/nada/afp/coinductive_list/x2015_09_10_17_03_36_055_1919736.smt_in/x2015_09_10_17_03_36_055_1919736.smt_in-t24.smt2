...
(assert (not (= (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$)) true)))
(assert (not (not (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$)))))
(assert (= (= (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$)) true) (fun_app$ (less_eq$ (llength$ us$)) (llength$a xs$))))
(check-sat)
(exit)
