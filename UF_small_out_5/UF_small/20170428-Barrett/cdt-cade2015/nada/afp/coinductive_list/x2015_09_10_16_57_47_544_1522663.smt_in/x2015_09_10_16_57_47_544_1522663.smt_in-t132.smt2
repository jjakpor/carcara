...
(assert (not (= lNil$ (fun_app$c (ldropn$ (suc$ n$)) xs$))))
(assert (not (not (or (not (fun_app$q lnull$d xs$)) (= lNil$ (fun_app$c (ldropn$ (suc$ n$)) xs$))))))
(assert (or (not (or (not (fun_app$q lnull$d xs$)) (= lNil$ (fun_app$c (ldropn$ (suc$ n$)) xs$)))) (not (fun_app$q lnull$d xs$)) (= lNil$ (fun_app$c (ldropn$ (suc$ n$)) xs$))))
(check-sat)
(exit)
