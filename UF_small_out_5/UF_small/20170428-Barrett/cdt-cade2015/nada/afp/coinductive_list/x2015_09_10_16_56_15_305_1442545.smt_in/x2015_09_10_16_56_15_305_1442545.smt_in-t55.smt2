...
(assert (not (= (= (fun_app$h lnull$ (fun_app$c (ltake$ n$) xs$)) (or (fun_app$h lnull$ xs$) (= n$ zero$))) (= (fun_app$h lnull$ (fun_app$c (ltake$ n$) xs$)) (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)))))))
(assert (= (fun_app$h lnull$ (fun_app$c (ltake$ n$) xs$)) (fun_app$h lnull$ (fun_app$c (ltake$ n$) xs$))))
(assert (= (or (fun_app$h lnull$ xs$) (= n$ zero$)) (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$)))))
(check-sat)
(exit)
