...
(assert (not (= (or (fun_app$h lnull$ xs$) (= n$ zero$)) (or (fun_app$h lnull$ xs$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))))
(assert (= (fun_app$h lnull$ xs$) (fun_app$h lnull$ xs$)))
(assert (= (= n$ zero$) (= n$ (fun_app$n (enat_unfold$b lnull$ uud$) lNil$))))
(check-sat)
(exit)
