...
(assert (not (not (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$))))
(assert (not (fun_app$m (fun_app$n lprefix$ xs$) ys$)))
(assert (or (not (= (not (fun_app$m (fun_app$n lprefix$ xs$) ys$)) (not (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$)))) (not (not (fun_app$m (fun_app$n lprefix$ xs$) ys$))) (not (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$))))
(assert (= (not (fun_app$m (fun_app$n lprefix$ xs$) ys$)) (not (fun_app$m (fun_app$n finite_lprefix$ xs$) ys$))))
(check-sat)
(exit)
