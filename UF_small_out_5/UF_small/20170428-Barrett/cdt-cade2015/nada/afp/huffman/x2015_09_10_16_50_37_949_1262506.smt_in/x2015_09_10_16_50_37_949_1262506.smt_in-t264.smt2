...
(assert (not (not (or (not (member$ d$ (alphabet$ t$))) (= a$ d$) (= b$ d$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) d$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) d$)))))))
(assert (or (not (or (not (member$ d$ (alphabet$ t$))) (= a$ d$) (= b$ d$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) d$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) d$))))) (not (member$ d$ (alphabet$ t$))) (= a$ d$) (= b$ d$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) d$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) d$)))))
(check-sat)
(exit)
