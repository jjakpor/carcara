...
(assert (not (= (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$)) true)))
(assert (not (not (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$)))))
(assert (= (= (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$)) true) (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$))))
(check-sat)
(exit)
