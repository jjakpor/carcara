...
(assert (not (not (forall ((?v0 A_tree$) (?v1 A$)) (fun_app$b (less_eq$ (depth$ ?v0 ?v1)) (height$ ?v0))))))
(assert (not (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$))))
(assert (or (not (forall ((?v0 A_tree$) (?v1 A$)) (fun_app$b (less_eq$ (depth$ ?v0 ?v1)) (height$ ?v0)))) (fun_app$b (less_eq$ (depth$ t$ b$)) (height$ t$))))
(check-sat)
(exit)
