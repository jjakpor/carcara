...
(assert (consistent$ t$))
(assert (or (not (consistent$ t$)) (= t$ (fun_app$f (swapSyms$ t$ b$) b$)) (not (or (not (consistent$ t$)) (= t$ (fun_app$f (swapSyms$ t$ b$) b$))))))
(assert (or (not (consistent$ t$)) (= t$ (fun_app$f (swapSyms$ t$ b$) b$))))
(check-sat)
(exit)
