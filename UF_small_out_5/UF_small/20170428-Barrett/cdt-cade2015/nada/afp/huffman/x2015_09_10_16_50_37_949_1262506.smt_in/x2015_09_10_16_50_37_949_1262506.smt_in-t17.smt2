...
(assert (not (not (= (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$)) true))))
(assert (not (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$))))
(assert (= (= (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$)) true) (fun_app$b (less_eq$ (depth$ t$ a$)) (depth$ t$ d$))))
(check-sat)
(exit)
