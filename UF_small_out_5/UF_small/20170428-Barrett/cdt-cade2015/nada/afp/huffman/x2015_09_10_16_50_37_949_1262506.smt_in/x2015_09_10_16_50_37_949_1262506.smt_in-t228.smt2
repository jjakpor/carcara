...
(assert (= (swapFourSyms$ t$ a$ b$ c$ d$) (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$)))))
...
(assert (or (not (consistent$ t$)) (not (member$ c$ (alphabet$ t$))) (not (member$ b$ (alphabet$ t$))) (not (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$))) (not (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$))) (fun_app$b (less_eq$ (cost$ (fun_app$f (swapSyms$ t$ b$) c$))) (cost$ t$)) (not (or (not (consistent$ t$)) (not (member$ b$ (alphabet$ t$))) (not (member$ c$ (alphabet$ t$))) (not (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$))) (not (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$))) (fun_app$b (less_eq$ (cost$ (fun_app$f (swapSyms$ t$ b$) c$))) (cost$ t$))))))
(assert (or (not (consistent$ t$)) (not (member$ b$ (alphabet$ t$))) (not (member$ c$ (alphabet$ t$))) (not (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$))) (not (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$))) (fun_app$b (less_eq$ (cost$ (fun_app$f (swapSyms$ t$ b$) c$))) (cost$ t$))))
(assert (fun_app$b (less_eq$ (depth$ t$ b$)) (depth$ t$ c$)))
(assert (member$ b$ (alphabet$ t$)))
(assert (or (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$)) (not (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) c$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$))))))
(assert (or (= b$ c$) (not (member$ c$ (alphabet$ t$))) (= a$ c$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) c$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$))) (not (or (not (member$ c$ (alphabet$ t$))) (= a$ c$) (= b$ c$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) c$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$)))))))
(assert (or (not (member$ c$ (alphabet$ t$))) (= a$ c$) (= b$ c$) (and (fun_app$b (less_eq$ (fun_app$a (freq$ t$) a$)) (fun_app$a (freq$ t$) c$)) (fun_app$b (less_eq$ (fun_app$a (freq$ t$) b$)) (fun_app$a (freq$ t$) c$)))))
(assert (or (not (= b$ c$)) (= (cost$ (swapFourSyms$ t$ a$ b$ c$ d$)) (cost$ t$)) (not (= (swapFourSyms$ t$ a$ b$ c$ d$) (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$))))) (not (= (fun_app$f (swapSyms$ t$ b$) c$) (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$))))) (not (= t$ (fun_app$f (swapSyms$ t$ b$) b$)))))
(assert (= t$ (fun_app$f (swapSyms$ t$ b$) b$)))
(assert (not (= (cost$ (swapFourSyms$ t$ a$ b$ c$ d$)) (cost$ t$))))
(assert (or (= c$ d$) (not (= a$ d$)) (not (= a$ c$))))
(assert (or (not (= a$ d$)) (= (fun_app$f (swapSyms$ t$ b$) c$) (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$))))))
(check-sat)
(exit)
