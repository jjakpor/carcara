...
(assert (not (= (= sk_?X_3$0 (union$0 sk_?X_5$0 sk_?X_4$0)) (= sk_?X_3$0 (union$0 sk_?X_5$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))))
(assert (= sk_?X_3$0 sk_?X_3$0))
(assert (= (union$0 sk_?X_5$0 sk_?X_4$0) (union$0 sk_?X_5$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))
(check-sat)
(exit)
