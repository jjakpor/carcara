...
(assert (not (not (= (= sk_?X$0 (lseg_domain$0 next$0 lst$0 null$0)) (= sk_?X$0 (lseg_domain$0 next$0 lst$0 cp_2$0))))))
(assert (not (not (= sk_?X$0 (lseg_domain$0 next$0 lst$0 null$0)))))
