...
(assert (not (= (or (= curr_init$0 curr_init$0) (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))) (or true (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))))))
(assert (= (= curr_init$0 curr_init$0) true))
(assert (= (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0)) (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))))
(check-sat)
(exit)
