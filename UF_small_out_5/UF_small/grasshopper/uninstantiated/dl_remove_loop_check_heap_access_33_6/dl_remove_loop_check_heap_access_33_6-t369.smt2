...
(assert (not (not (and (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)) (or (in$0 (read$0 next$0 d_init$0) FP_Caller$0) (in$0 (read$0 next$0 d_init$0) Alloc$0))))))
(assert (or (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)) (not (and (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)) (or (in$0 (read$0 next$0 d_init$0) FP_Caller$0) (in$0 (read$0 next$0 d_init$0) Alloc$0))))))
(assert (not (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0))))
(check-sat)
(exit)
