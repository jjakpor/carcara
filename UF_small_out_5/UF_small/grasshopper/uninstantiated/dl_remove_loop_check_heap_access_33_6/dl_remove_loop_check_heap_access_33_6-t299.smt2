...
(assert (not (= (or (= curr_init$0 curr_init$0) (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))) true)))
(assert (= (or (= curr_init$0 curr_init$0) (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))) (or true (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0)))))
(assert (= (or true (not (Btwn$0 next$0 c_init$0 curr_init$0 curr_init$0))) true))
(check-sat)
(exit)
