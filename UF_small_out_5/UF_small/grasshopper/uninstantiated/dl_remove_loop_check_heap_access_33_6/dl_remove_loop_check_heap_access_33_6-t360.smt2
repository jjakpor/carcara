...
(assert (not (= (in$0 (read$0 next$0 d_init$0) Alloc$0) false)))
(assert (not (in$0 (read$0 next$0 d_init$0) Alloc$0)))
(assert (or (= (in$0 (read$0 next$0 d_init$0) Alloc$0) false) (not (not (in$0 (read$0 next$0 d_init$0) Alloc$0)))))
(assert (or (not (not (not (in$0 (read$0 next$0 d_init$0) Alloc$0)))) (in$0 (read$0 next$0 d_init$0) Alloc$0)))
(check-sat)
(exit)
