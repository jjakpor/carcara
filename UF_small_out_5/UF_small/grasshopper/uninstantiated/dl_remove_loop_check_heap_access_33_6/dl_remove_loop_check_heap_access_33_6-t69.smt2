...
(assert (not (= prv_init$0 (read$0 prev$0 prv_5$0))))
(assert (or (not (= (= prv_init$0 (read$0 prev$0 curr_init$0)) (= prv_init$0 (read$0 prev$0 prv_5$0)))) (not (= prv_init$0 (read$0 prev$0 curr_init$0))) (= prv_init$0 (read$0 prev$0 prv_5$0))))
(assert (= (= prv_init$0 (read$0 prev$0 curr_init$0)) (= prv_init$0 (read$0 prev$0 prv_5$0))))
(assert (= prv_init$0 (read$0 prev$0 curr_init$0)))
(check-sat)
(exit)
