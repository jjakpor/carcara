...
(assert (or (not (= (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)) false)) (not (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)))))
(assert (= (in$0 (read$0 next$0 d_init$0) (union$0 FP_Caller$0 Alloc$0)) false))
(check-sat)
(exit)
