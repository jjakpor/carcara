...
(declare-fun x$0 () Loc)
(assert (not (= (union$0 sk_?X_27$0 sk_?X_25$0) (union$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0)))))
(assert (= sk_?X_27$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0)))
(assert (= sk_?X_25$0 (setenum$0 root_x$0)))
(check-sat)
(exit)
