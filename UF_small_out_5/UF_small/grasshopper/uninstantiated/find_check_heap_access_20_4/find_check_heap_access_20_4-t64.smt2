...
(assert (or (not (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))) (= (read$0 next_2$0 x$0) (read$0 next$0 x$0)) (not (= root_x$0 x$0))))
(assert (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0)))
(assert (or (= (read$0 next$0 x$0) (read$0 next$0 root_x$0)) (not (= (read$0 next$0 root_x$0) (read$0 next_2$0 root_x$0))) (not (= (read$0 next_2$0 x$0) (read$0 next$0 x$0))) (not (= root_x$0 x$0))))
