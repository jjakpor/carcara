...
(declare-fun x$0 () Loc)
(assert (not (= (=> (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?x)) (= ?x ?y))) (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= x$0 root_x$0))) (=> (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?x)) (= ?x ?y))) (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0))))))
(assert (= (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?x)) (= ?x ?y))) (forall ((?f FldLoc) (?x Loc) (?y Loc)) (or (not (Btwn$0 ?f ?x ?y ?x)) (= ?x ?y)))))
(assert (= (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= x$0 root_x$0)) (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0))))
(check-sat)
(exit)
