...
(assert (or (= lst$0 (read$0 next$0 lst$0)) (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) lst$0)) (not (or (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) lst$0)) (= lst$0 (read$0 next$0 lst$0))))))
(assert (or (not (Btwn$0 next$0 lst$0 (read$0 next$0 lst$0) lst$0)) (= lst$0 (read$0 next$0 lst$0))))
(check-sat)
(exit)
