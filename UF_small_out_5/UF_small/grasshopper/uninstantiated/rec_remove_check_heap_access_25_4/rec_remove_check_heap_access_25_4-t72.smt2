...
(assert (not (= (or (not (= lst$0 (read$0 next$0 lst$0))) (not (Btwn$0 next$0 lst$0 null$0 null$0)) (= lst$0 null$0)) (or (not (= lst$0 (read$0 next$0 lst$0))) (not (Btwn$0 next$0 lst$0 null$0 null$0)) (= null$0 lst$0)))))
(assert (= (not (Btwn$0 next$0 lst$0 null$0 null$0)) (not (Btwn$0 next$0 lst$0 null$0 null$0))))
(assert (= (= lst$0 null$0) (= null$0 lst$0)))
(assert (= (not (= lst$0 (read$0 next$0 lst$0))) (not (= lst$0 (read$0 next$0 lst$0)))))
(check-sat)
(exit)
