...
(assert (not (= (forall ((BOUND_VARIABLE_801 Loc)) (or (not (= null$0 BOUND_VARIABLE_801)) (and (or (= null$0 BOUND_VARIABLE_801) (not (Btwn$0 next$0 lst$0 BOUND_VARIABLE_801 null$0))) (not (in$0 BOUND_VARIABLE_801 (lseg_domain$0 next$0 lst$0 null$0)))))) (or (not (= null$0 null$0)) (and (or (= null$0 null$0) (not (Btwn$0 next$0 lst$0 null$0 null$0))) (not (in$0 null$0 (lseg_domain$0 next$0 lst$0 null$0))))))))
(check-sat)
(exit)
