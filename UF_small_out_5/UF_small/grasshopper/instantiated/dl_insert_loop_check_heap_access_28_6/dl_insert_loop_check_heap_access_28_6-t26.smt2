...
(assert (not (= (and (= curr_init$0 null$0) (= prv_init$0 d_init$0)) (and (= null$0 curr_init$0) (= d_init$0 prv_init$0)))))
(assert (= (= curr_init$0 null$0) (= null$0 curr_init$0)))
(assert (= (= prv_init$0 d_init$0) (= d_init$0 prv_init$0)))
(check-sat)
(exit)
