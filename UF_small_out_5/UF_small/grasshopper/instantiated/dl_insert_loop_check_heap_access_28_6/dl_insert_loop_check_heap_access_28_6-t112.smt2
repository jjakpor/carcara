...
(assert (not (Btwn$0 next$0 prv_5$0 prv_5$0 prv_5$0)))
(assert (not (not (and (Btwn$0 next$0 c_init$0 prv_5$0 prv_5$0) (Btwn$0 next$0 prv_5$0 prv_5$0 prv_5$0)))))
(assert (or (not (and (Btwn$0 next$0 c_init$0 prv_5$0 prv_5$0) (Btwn$0 next$0 prv_5$0 prv_5$0 prv_5$0))) (Btwn$0 next$0 prv_5$0 prv_5$0 prv_5$0)))
(check-sat)
(exit)
