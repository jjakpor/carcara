...
(assert (not (= (in$0 prv_2$0 Alloc_1$0) false)))
(assert (not (in$0 prv_2$0 Alloc_1$0)))
(assert (or (= (in$0 prv_2$0 Alloc_1$0) false) (not (not (in$0 prv_2$0 Alloc_1$0)))))
(assert (or (not (not (not (in$0 prv_2$0 Alloc_1$0)))) (in$0 prv_2$0 Alloc_1$0)))
(check-sat)
(exit)
