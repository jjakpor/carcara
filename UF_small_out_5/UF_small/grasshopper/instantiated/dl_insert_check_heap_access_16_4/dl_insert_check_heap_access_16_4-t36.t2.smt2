...
(assert (not (= (forall ((x Loc)) (or (and (in$0 x (union$0 sk_?X_3$0 sk_?X_1$0)) (or (in$0 x sk_?X_3$0) (in$0 x sk_?X_1$0))) (and (not (in$0 x sk_?X_3$0)) (not (in$0 x sk_?X_1$0)) (not (in$0 x (union$0 sk_?X_3$0 sk_?X_1$0)))))) (forall ((x Loc)) (or (and (in$0 x (union$0 (dlseg_domain$0 next$0 prev$0 (read$0 next$0 elt$0) (read$0 next$0 elt$0) (read$0 next$0 elt$0) b$0) (setenum$0 elt$0))) (or (in$0 x (dlseg_domain$0 next$0 prev$0 (read$0 next$0 elt$0) (read$0 next$0 elt$0) (read$0 next$0 elt$0) b$0)) (in$0 x (setenum$0 elt$0)))) (and (not (in$0 x (dlseg_domain$0 next$0 prev$0 (read$0 next$0 elt$0) (read$0 next$0 elt$0) (read$0 next$0 elt$0) b$0))) (not (in$0 x (setenum$0 elt$0))) (not (in$0 x (union$0 (dlseg_domain$0 next$0 prev$0 (read$0 next$0 elt$0) (read$0 next$0 elt$0) (read$0 next$0 elt$0) b$0) (setenum$0 elt$0))))))))))
(assert (= sk_?X_3$0 (dlseg_domain$0 next$0 prev$0 (read$0 next$0 elt$0) (read$0 next$0 elt$0) (read$0 next$0 elt$0) b$0)))
(check-sat)
(exit)
