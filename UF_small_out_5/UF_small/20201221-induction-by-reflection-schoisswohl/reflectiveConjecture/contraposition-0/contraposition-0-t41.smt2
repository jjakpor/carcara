...
(assert (not (= (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (models empty (notR (qR bR))) (not (models empty (qR bR))))) (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (not (models empty (qR bR))) (models empty (notR (qR bR))))))))
(assert (= (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))))
(assert (= (= (models empty (notR (qR bR))) (not (models empty (qR bR)))) (= (not (models empty (qR bR))) (models empty (notR (qR bR))))))
(check-sat)
(exit)
