...
(assert (not (= (or (not (= (not (models empty (qR bR))) (models empty (notR (qR bR))))) (not (not (models empty (qR bR)))) (models empty (notR (qR bR)))) (or (not (= (not (models empty (qR bR))) (models empty (notR (qR bR))))) (models empty (qR bR)) (models empty (notR (qR bR)))))))
(assert (= (not (= (not (models empty (qR bR))) (models empty (notR (qR bR))))) (not (= (not (models empty (qR bR))) (models empty (notR (qR bR)))))))
(assert (= (not (not (models empty (qR bR)))) (models empty (qR bR))))
(assert (= (models empty (notR (qR bR))) (models empty (notR (qR bR)))))
(check-sat)
(exit)
