...
(assert (not (= (models empty (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))) (or (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))
(assert (or (not (forall ((env env) (phi form) (psi form)) (= (models env (orR phi psi)) (or (models env phi) (models env psi))))) (= (models empty (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))) (or (models empty (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))))) (models empty (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))
(check-sat)
(exit)
