...
(assert (not (models empty (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))))
(assert (not (not (or (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (models empty (rR cR))))))
(assert (not (not (= (models empty (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))) (or (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (models empty (rR cR)))))))
(assert (or (not (= (models empty (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))) (or (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (models empty (rR cR))))) (models empty (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR))) (not (or (models empty (notR (notR (orR (notR (pR aR)) (notR (qR bR)))))) (models empty (rR cR))))))
(check-sat)
(exit)
