...
(assert (or (not (= (models empty (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))) (not (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))) (models empty (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))) (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))
(check-sat)
(exit)
