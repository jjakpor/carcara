...
(assert (or (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))) (not (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR))))) (not (= (models empty (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))) (or (models empty (notR (pR aR))) (models empty (orR (notR (qR bR)) (rR cR))))))))
