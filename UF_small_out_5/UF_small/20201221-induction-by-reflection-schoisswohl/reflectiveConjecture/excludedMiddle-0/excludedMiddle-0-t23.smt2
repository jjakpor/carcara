...
(assert (not (not (or (models empty (pR aR)) (models empty (notR (pR aR)))))))
(assert (not (not (= (models empty (orR (pR aR) (notR (pR aR)))) (or (models empty (pR aR)) (models empty (notR (pR aR))))))))
(assert (or (not (= (models empty (orR (pR aR) (notR (pR aR)))) (or (models empty (pR aR)) (models empty (notR (pR aR)))))) (models empty (orR (pR aR) (notR (pR aR)))) (not (or (models empty (pR aR)) (models empty (notR (pR aR)))))))
(check-sat)
(exit)
