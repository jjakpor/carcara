...
(assert (or (models empty (orR (pR aR) (notR (pR aR)))) (not (or (models empty (pR aR)) (models empty (notR (pR aR))))) (not (= (models empty (orR (pR aR) (notR (pR aR)))) (or (models empty (pR aR)) (models empty (notR (pR aR))))))))
(assert (= (models empty (orR (pR aR) (notR (pR aR)))) (or (models empty (pR aR)) (models empty (notR (pR aR))))))
(check-sat)
(exit)
