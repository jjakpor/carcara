...
(assert (not (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (models empty (notR (pR aR))) (not (models empty (pR aR)))))))
(assert (not (= (models empty (notR (pR aR))) (not (models empty (pR aR))))))
(assert (or (=> (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi)))) (= (models empty (notR (pR aR))) (not (models empty (pR aR))))) (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))))
(assert (or (not (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))) (= (models empty (notR (pR aR))) (not (models empty (pR aR))))))
(check-sat)
(exit)
