...
(assert (not (= (equal (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))) (equal zero zero zero))))
(assert (= (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) zero))
(check-sat)
(exit)
