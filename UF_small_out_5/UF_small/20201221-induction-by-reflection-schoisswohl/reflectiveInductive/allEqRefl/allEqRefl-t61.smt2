...
(assert (not (not (= (equal (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))) true))))
(assert (not (equal (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))))
(assert (= (= (equal (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))) true) (equal (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))))
(check-sat)
(exit)
