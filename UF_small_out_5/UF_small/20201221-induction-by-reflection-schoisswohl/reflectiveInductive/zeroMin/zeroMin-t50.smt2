...
(assert (not (= zero (eval_nat (push_nat empty v0_nat zero) zeroR))))
(assert (or (not (forall ((env env)) (= zero (eval_nat env zeroR)))) (= zero (eval_nat (push_nat empty v0_nat zero) zeroR))))
(check-sat)
(exit)
