...
(assert (not (or (not (forall ((env env) (t0 term_nat) (t1 term_nat)) (= (models env (leqR t0 t1)) (leq (eval_nat env t0) (eval_nat env t1))))) (= (models (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (leqR zeroR (inj_nat v0_nat))) (leq (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) zeroR) (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (inj_nat v0_nat)))))))
(check-sat)
(exit)
