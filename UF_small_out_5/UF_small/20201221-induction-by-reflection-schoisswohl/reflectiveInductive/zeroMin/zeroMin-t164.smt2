...
(assert (not (forall ((x nat) (y nat)) (or (not (leq x y)) (leq x (s y))))))
(assert (forall ((x nat) (y nat)) (=> (leq x y) (leq x (s y)))))
(assert (or (not (= (forall ((x nat) (y nat)) (=> (leq x y) (leq x (s y)))) (forall ((x nat) (y nat)) (or (not (leq x y)) (leq x (s y)))))) (not (forall ((x nat) (y nat)) (=> (leq x y) (leq x (s y))))) (forall ((x nat) (y nat)) (or (not (leq x y)) (leq x (s y))))))
(assert (= (forall ((x nat) (y nat)) (=> (leq x y) (leq x (s y)))) (forall ((x nat) (y nat)) (or (not (leq x y)) (leq x (s y))))))
(check-sat)
(exit)
