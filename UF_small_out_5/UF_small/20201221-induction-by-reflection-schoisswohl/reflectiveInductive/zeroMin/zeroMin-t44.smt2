...
(assert (not (not (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))))))
(assert (not (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (leqR zeroR (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (leqR zeroR (inj_nat v0_nat))))))))
(assert (not (models (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (leqR zeroR (inj_nat v0_nat)))))
(assert (not (not (or (not (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat)))) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (leqR zeroR (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (leqR zeroR (inj_nat v0_nat)))))) (models (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (leqR zeroR (inj_nat v0_nat)))))))
(assert (or (not (or (not (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat)))) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (leqR zeroR (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (leqR zeroR (inj_nat v0_nat)))))) (models (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (leqR zeroR (inj_nat v0_nat))))) (not (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat)))) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (leqR zeroR (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (leqR zeroR (inj_nat v0_nat)))))) (models (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) (leqR zeroR (inj_nat v0_nat)))))
(check-sat)
(exit)
