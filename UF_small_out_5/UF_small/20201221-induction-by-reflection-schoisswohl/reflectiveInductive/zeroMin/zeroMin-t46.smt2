...
(assert (not (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat)))))
(assert (not (not (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))))))
(assert (not (not (= (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))))))
(assert (or (not (= (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))))) (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (not (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))))))
(check-sat)
(exit)
