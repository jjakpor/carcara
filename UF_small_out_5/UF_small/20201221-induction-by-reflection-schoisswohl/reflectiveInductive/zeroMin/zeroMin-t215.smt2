...
(assert (or (not (= (not (forall ((x nat)) (leq zero x))) (not (leq zero (choice ((x nat)) (not (leq zero x))))))) (not (not (forall ((x nat)) (leq zero x)))) (not (leq zero (choice ((x nat)) (not (leq zero x)))))))
(assert (= (not (forall ((x nat)) (leq zero x))) (not (leq zero (choice ((x nat)) (not (leq zero x)))))))
(check-sat)
(exit)
