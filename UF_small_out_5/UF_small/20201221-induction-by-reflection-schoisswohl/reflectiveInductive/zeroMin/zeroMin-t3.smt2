...
(assert (not (= (not (= (choice ((x nat)) (not (leq zero x))) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) v0_nat))) (not (= (choice ((x nat)) (not (leq zero x))) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) v0_nat))))))
(check-sat)
(exit)
