...
(declare-fun b () Set)
(declare-fun c () Set)
(assert (not (= (not (not (member (choice ((?x Elem)) (not (or (not (member ?x (union a b))) (member ?x c)))) (union a b)))) (member (choice ((?x Elem)) (not (or (not (member ?x (union a b))) (member ?x c)))) (union a b)))))
(check-sat)
(exit)
