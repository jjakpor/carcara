...
(assert (= xs$ (fun_app$g llist_of$ (choice ((?v3 A_list$)) (not (or (not (member$c ?v3 (collect$a top$b))) (not (= xs$ (fun_app$g llist_of$ ?v3)))))))))
(assert (forall ((?v0 A_list$)) (not (= xs$ (fun_app$g llist_of$ ?v0)))))
(check-sat)
(exit)
