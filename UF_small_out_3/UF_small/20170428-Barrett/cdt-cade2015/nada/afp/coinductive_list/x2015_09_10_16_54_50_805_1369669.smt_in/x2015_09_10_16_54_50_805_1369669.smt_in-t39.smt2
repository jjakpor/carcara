...
(assert (member$ xs$ (image$ llist_of$ (collect$a top$b))))
(assert (= (member$ xs$ (image$ llist_of$ (collect$a top$b))) (not (forall ((?v3 A_list$)) (or (not (member$c ?v3 (collect$a top$b))) (not (= xs$ (fun_app$g llist_of$ ?v3))))))))
(check-sat)
(exit)
