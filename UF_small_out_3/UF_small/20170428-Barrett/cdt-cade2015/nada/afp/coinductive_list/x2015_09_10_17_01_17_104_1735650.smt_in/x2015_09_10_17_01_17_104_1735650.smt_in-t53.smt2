...
(assert (not (= (fun_app$a (fun_app$b (fun_app$c compow$ n$) f$) x$) (fun_app$a (fun_app$b (fun_app$c funpow$ n$) f$) x$))))
(assert (= (fun_app$b (fun_app$c compow$ n$) f$) (fun_app$b (fun_app$c funpow$ n$) f$)))
(assert (= x$ x$))
(check-sat)
(exit)
