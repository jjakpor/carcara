...
(assert (not (= (forall ((?v0 A$) (?v1 A_llist$)) (=> (= (lCons$ ?v0 ?v1) (lconcat$ xssa$)) thesis$)) (or thesis$ (forall ((?v0 A$) (?v1 A_llist$)) (not (= (lCons$ ?v0 ?v1) (lconcat$ xssa$))))))))
(assert (= (forall ((?v0 A$) (?v1 A_llist$)) (=> (= (lCons$ ?v0 ?v1) (lconcat$ xssa$)) thesis$)) (forall ((?v0 A$) (?v1 A_llist$)) (or (not (= (lCons$ ?v0 ?v1) (lconcat$ xssa$))) thesis$))))
(assert (= (forall ((?v0 A$) (?v1 A_llist$)) (or (not (= (lCons$ ?v0 ?v1) (lconcat$ xssa$))) thesis$)) (or thesis$ (forall ((?v0 A$) (?v1 A_llist$)) (not (= (lCons$ ?v0 ?v1) (lconcat$ xssa$)))))))
(check-sat)
(exit)
