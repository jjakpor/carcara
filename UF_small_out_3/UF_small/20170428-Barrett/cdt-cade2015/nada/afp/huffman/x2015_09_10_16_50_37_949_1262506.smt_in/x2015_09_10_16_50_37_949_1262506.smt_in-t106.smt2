...
(assert (not (= (= (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$))) (fun_app$f (swapSyms$ t$ b$) c$)) (= (ite (= a$ d$) (fun_app$f (swapSyms$ t$ b$) c$) (ite (= b$ c$) (fun_app$f (swapSyms$ t$ a$) d$) (fun_app$f (swapSyms$ (fun_app$f (swapSyms$ t$ a$) c$) b$) d$))) (fun_app$f (swapSyms$ t$ b$) c$)))))
...
(assert (= (fun_app$f (swapSyms$ t$ b$) c$) (fun_app$f (swapSyms$ t$ b$) c$)))
(check-sat)
(exit)
