...
(assert (not (or (not (= b$ c$)) (= c$ d$) (not (= b$ d$)))))
(assert (or (not (= (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))) (or (not (= b$ c$)) (= c$ d$) (not (= b$ d$))))) (not (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$)))) (or (not (= b$ c$)) (= c$ d$) (not (= b$ d$)))))
(assert (= (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))) (or (not (= b$ c$)) (= c$ d$) (not (= b$ d$)))))
(assert (or (not (= b$ c$)) (not (not (= c$ d$))) (not (= b$ d$))))
(check-sat)
(exit)
