...
(assert (not (not (forall ((?v0 A_tree$) (?v1 A$)) (or (not (consistent$ ?v0)) (= ?v0 (fun_app$f (swapSyms$ ?v0 ?v1) ?v1)))))))
(assert (not (or (not (consistent$ t$)) (= t$ (fun_app$f (swapSyms$ t$ b$) b$)))))
(assert (or (not (forall ((?v0 A_tree$) (?v1 A$)) (or (not (consistent$ ?v0)) (= ?v0 (fun_app$f (swapSyms$ ?v0 ?v1) ?v1))))) (or (not (consistent$ t$)) (= t$ (fun_app$f (swapSyms$ t$ b$) b$)))))
(check-sat)
(exit)
