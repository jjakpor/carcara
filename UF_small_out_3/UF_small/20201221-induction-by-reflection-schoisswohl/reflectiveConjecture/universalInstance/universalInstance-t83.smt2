...
(assert (not (not (= (models empty (pR aR)) (p (eval_alpha empty aR))))))
(assert (or (not (= (models empty (pR aR)) (p (eval_alpha empty aR)))) (models empty (pR aR)) (not (p (eval_alpha empty aR)))))
(check-sat)
(exit)
