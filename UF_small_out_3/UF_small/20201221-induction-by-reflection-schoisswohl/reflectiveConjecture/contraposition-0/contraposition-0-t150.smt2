...
(assert (models empty (orR (notR (orR (notR (pR aR)) (qR bR))) (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))))
(assert (= (models empty (orR (notR (orR (notR (pR aR)) (qR bR))) (notR (orR (notR (notR (qR bR))) (notR (pR aR)))))) (or (models empty (notR (orR (notR (pR aR)) (qR bR)))) (models empty (notR (orR (notR (notR (qR bR))) (notR (pR aR))))))))
(check-sat)
(exit)
