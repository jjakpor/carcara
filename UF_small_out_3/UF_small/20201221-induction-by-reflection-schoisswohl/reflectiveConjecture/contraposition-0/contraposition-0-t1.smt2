...
(assert (not (not (models empty (qR bR)))))
(assert (not (not (models empty (notR (qR bR))))))
(assert (not (not (= (not (models empty (qR bR))) (models empty (notR (qR bR)))))))
(assert (or (not (= (not (models empty (qR bR))) (models empty (notR (qR bR))))) (not (models empty (qR bR))) (not (models empty (notR (qR bR))))))
(check-sat)
(exit)
