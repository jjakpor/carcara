...
(assert (not (models empty (notR (notR (qR bR))))))
(assert (not (models empty (notR (qR bR)))))
(assert (not (not (= (models empty (notR (notR (qR bR)))) (not (models empty (notR (qR bR))))))))
(assert (or (not (= (models empty (notR (notR (qR bR)))) (not (models empty (notR (qR bR)))))) (models empty (notR (notR (qR bR)))) (models empty (notR (qR bR)))))
(check-sat)
(exit)
