...
(assert (or (models empty (notR (orR (notR (pR aR)) (qR bR)))) (models empty (orR (notR (pR aR)) (qR bR))) (not (= (models empty (notR (orR (notR (pR aR)) (qR bR)))) (not (models empty (orR (notR (pR aR)) (qR bR))))))))
(check-sat)
(exit)
