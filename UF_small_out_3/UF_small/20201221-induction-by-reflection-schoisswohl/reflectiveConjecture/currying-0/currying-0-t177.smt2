...
(assert (or (models empty (orR (notR (qR bR)) (rR cR))) (not (or (models empty (notR (qR bR))) (models empty (rR cR)))) (not (= (models empty (orR (notR (qR bR)) (rR cR))) (or (models empty (notR (qR bR))) (models empty (rR cR)))))))
