...
(assert (not (= (not (not (models empty (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))) (models empty (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))
(check-sat)
(exit)
