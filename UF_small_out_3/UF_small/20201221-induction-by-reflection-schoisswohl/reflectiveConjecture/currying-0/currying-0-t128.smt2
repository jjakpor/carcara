...
(assert (not (or (not (forall ((env env) (phi form)) (= (models env (notR phi)) (not (models env phi))))) (= (models empty (notR (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR)))))))) (not (models empty (orR (notR (notR (orR (notR (notR (orR (notR (pR aR)) (notR (qR bR))))) (rR cR)))) (notR (notR (orR (notR (pR aR)) (orR (notR (qR bR)) (rR cR))))))))))))
(check-sat)
(exit)
