...
(assert (not (not (models empty (orR (notR (pR aR)) (notR (qR bR)))))))
(assert (not (or (models empty (notR (pR aR))) (models empty (notR (qR bR))))))
(assert (not (not (= (models empty (orR (notR (pR aR)) (notR (qR bR)))) (or (models empty (notR (pR aR))) (models empty (notR (qR bR))))))))
(assert (or (not (= (models empty (orR (notR (pR aR)) (notR (qR bR)))) (or (models empty (notR (pR aR))) (models empty (notR (qR bR)))))) (not (models empty (orR (notR (pR aR)) (notR (qR bR))))) (or (models empty (notR (pR aR))) (models empty (notR (qR bR))))))
(check-sat)
(exit)
