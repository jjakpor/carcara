...
(assert (or (not (forall ((env env) (v var_nat)) (= (evalV_nat env v) (eval_nat env (inj_nat v))))) (= (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) (inj_nat v0_nat)) (evalV_nat (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) v0_nat))))
