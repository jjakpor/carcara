...
(assert (not (not (forall ((phi form) (BOUND_VARIABLE_560 nat)) (or (not (models (push_nat empty v0_nat zero) phi)) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) phi)) (models (push_nat empty v0_nat (s x0)) phi)))) (models (push_nat empty v0_nat BOUND_VARIABLE_560) phi))))))
(assert (not (or (not (models (push_nat empty v0_nat zero) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))))) (models (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat))))))
(assert (or (not (forall ((phi form) (BOUND_VARIABLE_560 nat)) (or (not (models (push_nat empty v0_nat zero) phi)) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) phi)) (models (push_nat empty v0_nat (s x0)) phi)))) (models (push_nat empty v0_nat BOUND_VARIABLE_560) phi)))) (or (not (models (push_nat empty v0_nat zero) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))) (not (forall ((x0 nat)) (or (not (models (push_nat empty v0_nat x0) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))) (models (push_nat empty v0_nat (s x0)) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat)))))) (models (push_nat empty v0_nat (choice ((x nat)) (not (equal x x x)))) (equalR (inj_nat v0_nat) (inj_nat v0_nat) (inj_nat v0_nat))))))
(check-sat)
(exit)
