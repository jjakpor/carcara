...
(assert (not (= (not (not (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x)))))) (equal (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x))) (choice ((x nat)) (not (equal x x x)))))))
(check-sat)
(exit)
