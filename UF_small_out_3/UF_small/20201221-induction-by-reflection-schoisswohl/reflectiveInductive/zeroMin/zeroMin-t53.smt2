...
(assert (not (forall ((env env)) (= zero (eval_nat env zeroR)))))
(assert (forall ((env env)) (= (eval_nat env zeroR) zero)))
(assert (or (not (= (forall ((env env)) (= (eval_nat env zeroR) zero)) (forall ((env env)) (= zero (eval_nat env zeroR))))) (not (forall ((env env)) (= (eval_nat env zeroR) zero))) (forall ((env env)) (= zero (eval_nat env zeroR)))))
(assert (= (forall ((env env)) (= (eval_nat env zeroR) zero)) (forall ((env env)) (= zero (eval_nat env zeroR)))))
(check-sat)
(exit)
