...
(assert (not (= (not (= zero (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) zeroR))) (not (= zero (eval_nat (push_nat empty v0_nat (choice ((x nat)) (not (leq zero x)))) zeroR))))))
(check-sat)
(exit)
