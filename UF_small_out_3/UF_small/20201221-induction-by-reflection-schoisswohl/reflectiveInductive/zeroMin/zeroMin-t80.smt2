...
(assert (or (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (not (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))) (not (= (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))))))
(assert (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat))))
(assert (= (models (push_nat empty v0_nat zero) (leqR zeroR (inj_nat v0_nat))) (leq (eval_nat (push_nat empty v0_nat zero) zeroR) (eval_nat (push_nat empty v0_nat zero) (inj_nat v0_nat)))))
(check-sat)
(exit)
