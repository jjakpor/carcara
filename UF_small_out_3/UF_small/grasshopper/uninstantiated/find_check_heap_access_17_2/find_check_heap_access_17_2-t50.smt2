...
(declare-fun x$0 () Loc)
(assert (not (= (= FP$0 sk_?X_2$0) (= FP$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0)))))
(assert (= FP$0 FP$0))
(assert (= sk_?X_2$0 (union$0 (lseg_set_domain$0 next$0 x$0 root_x$0) sk_?X_4$0)))
(check-sat)
(exit)
