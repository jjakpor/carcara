...
(assert (not (not (and (= null$0 curr_init$0) (= d_init$0 prv_init$0)))))
(assert (or (not (and (= null$0 curr_init$0) (= d_init$0 prv_init$0))) (= null$0 curr_init$0)))
(assert (not (= null$0 curr_init$0)))
(check-sat)
(exit)
