...
(assert (not (= (= curr_init$0 (read$0 next$0 prv_init$0)) (= prv_5$0 (read$0 next$0 (read$0 prev$0 prv_5$0))))))
(assert (= curr_init$0 prv_5$0))
(assert (= (read$0 next$0 prv_init$0) (read$0 next$0 (read$0 prev$0 prv_5$0))))
(check-sat)
(exit)
