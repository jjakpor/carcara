...
(assert (not (not (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0)))))
(assert (or (not (or (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0))) (not (Btwn$0 next$0 x$0 root_x$0 x$0)) (= root_x$0 x$0)))
(check-sat)
(exit)
