...
(declare-fun x$0 () Loc)
(assert (not (= (intersection$0 Alloc$0 FP_2$0) (intersection$0 Alloc$0 (union$0 (lseg_set_domain$0 next$0 (read$0 next$0 x$0) root_x$0) (setenum$0 root_x$0))))))
(assert (= Alloc$0 Alloc$0))
