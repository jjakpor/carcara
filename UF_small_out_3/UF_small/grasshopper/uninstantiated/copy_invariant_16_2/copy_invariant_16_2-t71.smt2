...
(assert (not (= (not (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)) (not (Btwn$0 next$0 lst$0 lst$0 lst$0)))))
(assert (= (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0) (Btwn$0 next$0 lst$0 lst$0 lst$0)))
(check-sat)
(exit)
