...
(assert (not (= (or (= curr_2$0 curr_2$0) (not (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0))) true)))
(assert (= (or (= curr_2$0 curr_2$0) (not (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0))) (or true (not (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)))))
(assert (= (or true (not (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0))) true))
(check-sat)
(exit)
