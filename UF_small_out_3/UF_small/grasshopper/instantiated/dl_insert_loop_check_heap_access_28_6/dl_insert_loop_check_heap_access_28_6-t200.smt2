...
(assert (not (= (= sk_?X_93$0 sk_?X_94$0) (= sk_?X_93$0 (dlseg_domain$0 next$0 prev$0 c_init$0 null$0 prv_5$0 prv_init$0)))))
(assert (= sk_?X_93$0 sk_?X_93$0))
(assert (= sk_?X_94$0 (dlseg_domain$0 next$0 prev$0 c_init$0 null$0 prv_5$0 prv_init$0)))
(check-sat)
(exit)
