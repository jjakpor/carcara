...
(assert (not (not (in$0 prv_2$0 Alloc_1$0))))
(assert (not (in$0 null$0 Alloc_1$0)))
(assert (or (not (= (not (in$0 null$0 Alloc_1$0)) (not (in$0 prv_2$0 Alloc_1$0)))) (not (not (in$0 null$0 Alloc_1$0))) (not (in$0 prv_2$0 Alloc_1$0))))
(assert (= (not (in$0 null$0 Alloc_1$0)) (not (in$0 prv_2$0 Alloc_1$0))))
(check-sat)
(exit)
