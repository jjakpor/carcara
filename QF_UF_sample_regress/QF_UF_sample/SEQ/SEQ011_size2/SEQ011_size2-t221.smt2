...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (not (or (= c_0 (f5 c_0)) (= c_1 (f5 c_0)))))
(assert (or (not (= (or (= (f5 c_0) c_0) (= (f5 c_0) c_1)) (or (= c_0 (f5 c_0)) (= c_1 (f5 c_0))))) (not (or (= (f5 c_0) c_0) (= (f5 c_0) c_1))) (or (= c_0 (f5 c_0)) (= c_1 (f5 c_0)))))
(assert (= (or (= (f5 c_0) c_0) (= (f5 c_0) c_1)) (or (= c_0 (f5 c_0)) (= c_1 (f5 c_0)))))
(assert (or (= (f5 c_0) c_0) (= (f5 c_0) c_1)))
(check-sat)
(exit)
