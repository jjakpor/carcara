...
(assert (not (not (and (= c_0 (f5 c_1)) (= c_0 (f6 c_1))))))
(assert (not (not (and (= c_0 (f5 c_1)) (= c_0 (f6 c_1))))))
(assert (or (not (= c_0 (f5 c_1))) (not (= c_0 (f6 c_1))) (= (f6 c_1) (f5 c_1))))
(assert (or (not (and (= c_0 (f5 c_1)) (= c_0 (f6 c_1)))) (= c_0 (f5 c_1))))
(assert (or (not (and (= c_0 (f5 c_1)) (= c_0 (f6 c_1)))) (= c_0 (f6 c_1))))
(check-sat)
(exit)
