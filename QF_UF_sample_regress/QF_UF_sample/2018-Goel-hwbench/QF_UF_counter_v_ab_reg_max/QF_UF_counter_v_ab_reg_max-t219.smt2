...
(assert (not (= y$42 (and (= y$n1s4 y$n1s4) (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))))
(assert (= y$42 (and (= y$X y$n1s4) (= y$n15s4 (Add_4_4_4 y$X y$n1s4)))))
(assert (= (and (= y$X y$n1s4) (= y$n15s4 (Add_4_4_4 y$X y$n1s4))) (and (= y$n1s4 y$n1s4) (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(check-sat)
(exit)
