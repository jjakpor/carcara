...
(assert (not (not y$v3_1517448494_34_op)))
(assert (or (not y$v3_1517448494_34_op) (and y$a_in_elevator_Person_0 y$a_in_elevator_Person_1)))
(assert (not (and y$a_in_elevator_Person_0 y$a_in_elevator_Person_1)))
(check-sat)
(exit)
