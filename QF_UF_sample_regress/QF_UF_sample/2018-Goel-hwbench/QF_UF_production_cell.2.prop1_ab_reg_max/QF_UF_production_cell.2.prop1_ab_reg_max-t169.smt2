...
(assert (not (= (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8) false)))
(assert (= (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8) (and (not (= y$n0s8 y$n1s8)) (not (= y$n0s8 y$n255s8)) (not (= y$n0s8 y$n5s8)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$n5s8)) (not (= y$n255s8 y$n5s8)))))
(assert (= (and (not (= y$n0s8 y$n1s8)) (not (= y$n0s8 y$n255s8)) (not (= y$n0s8 y$n5s8)) (not (= y$n1s8 y$n255s8)) (not (= y$n1s8 y$n5s8)) (not (= y$n255s8 y$n5s8))) false))
(check-sat)
(exit)
