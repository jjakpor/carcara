...
(assert (not (= (= (not true) (and (= y$n1s4 y$n1s4) (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))) (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))))
(assert (= (= (not true) (and (= y$n1s4 y$n1s4) (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))) (= false (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(assert (= (= false (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))) (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(check-sat)
(exit)
