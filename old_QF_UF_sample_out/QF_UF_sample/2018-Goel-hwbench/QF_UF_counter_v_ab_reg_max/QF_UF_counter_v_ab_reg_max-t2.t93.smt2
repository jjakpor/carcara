...
(assert (= (not y$26) (not true)))
(assert (= (not (= y$X$next y$n15s4)) (not (= (ite y$en (ite (= y$n15s4 y$n1s4) y$n1s4 (Add_4_4_4 y$n1s4 y$n1s4)) y$n1s4) y$n15s4))))
(assert (not (= (= (not y$26) (not (= y$X$next y$n15s4))) (= (not true) (not (= (ite y$en (ite (= y$n15s4 y$n1s4) y$n1s4 (Add_4_4_4 y$n1s4 y$n1s4)) y$n1s4) y$n15s4))))))
(check-sat)
(exit)
