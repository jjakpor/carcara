...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (or (not (= c_1 (f5 c_1))) (not (= c_1 (f6 c_1))) (= (f6 c_1) (f5 c_1))))
(assert (or (not (and (= c_1 (f5 c_1)) (= c_1 (f6 c_1)))) (= c_1 (f5 c_1))))
(assert (or (not (and (= c_1 (f5 c_1)) (= c_1 (f6 c_1)))) (= c_1 (f6 c_1))))
(assert (not (= (f6 c_1) (f5 c_1))))
(assert (not (not (and (= c_1 (f5 c_1)) (= c_1 (f6 c_1))))))
(assert (not (not (and (= c_1 (f5 c_1)) (= c_1 (f6 c_1))))))
(check-sat)
(exit)
