...
(declare-fun c_0 () U)
(declare-fun c_1 () U)
(assert (= (= (p1 (f7 c_0) c_0) (not (not (p1 (f7 c_0) c_0)))) (= (p1 (f7 c_0) c_0) (p1 (f7 c_0) c_0))))
(assert (= (= (p1 (f7 c_0) c_0) (p1 (f7 c_0) c_0)) true))
(assert (not (= (= (p1 (f7 c_0) c_0) (not (not (p1 (f7 c_0) c_0)))) true)))
(check-sat)
(exit)
