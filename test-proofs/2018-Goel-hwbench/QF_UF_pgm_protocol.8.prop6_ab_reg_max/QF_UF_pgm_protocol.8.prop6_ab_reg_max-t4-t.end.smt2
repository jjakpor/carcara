...
(assert (not (not (= (= y$9177 (= y$prop y$9176)) (= y$9177 (= y$9176 y$prop))))))
(assert (not (not (= y$9177 (= y$prop y$9176)))))
(assert (not (= y$9177 (= y$9176 y$prop))))
(assert (or (not (= (= y$9177 (= y$prop y$9176)) (= y$9177 (= y$9176 y$prop)))) (not (= y$9177 (= y$prop y$9176))) (= y$9177 (= y$9176 y$prop))))
(check-sat)
(exit)
