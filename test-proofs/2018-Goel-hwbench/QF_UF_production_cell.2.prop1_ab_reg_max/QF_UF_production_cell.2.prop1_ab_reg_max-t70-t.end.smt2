...
(assert (not (not (= y$78 (= y$v_k_Deposit y$v_k_Press)))))
(assert (not (not y$78)))
(assert (not (= y$v_k_Deposit y$v_k_Press)))
(assert (or (not (= y$78 (= y$v_k_Deposit y$v_k_Press))) (not y$78) (= y$v_k_Deposit y$v_k_Press)))
(check-sat)
(exit)
