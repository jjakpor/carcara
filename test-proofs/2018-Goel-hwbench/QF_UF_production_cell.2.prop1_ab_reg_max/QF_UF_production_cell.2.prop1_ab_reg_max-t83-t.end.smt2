...
(assert (not (not (= y$80 (= y$v_k_Press y$v_k_Table)))))
(assert (not (not y$80)))
(assert (not (= y$v_k_Press y$v_k_Table)))
(assert (or (not (= y$80 (= y$v_k_Press y$v_k_Table))) (not y$80) (= y$v_k_Press y$v_k_Table)))
(check-sat)
(exit)
