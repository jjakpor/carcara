...
(assert (not (not (= (= y$id44_op (and y$59 y$1522)) (= y$id44_op (and y$59 (= y$n5s8 y$v_done)))))))
(assert (not (not (= y$id44_op (and y$59 y$1522)))))
(assert (not (= y$id44_op (and y$59 (= y$n5s8 y$v_done)))))
(assert (or (not (= (= y$id44_op (and y$59 y$1522)) (= y$id44_op (and y$59 (= y$n5s8 y$v_done))))) (not (= y$id44_op (and y$59 y$1522))) (= y$id44_op (and y$59 (= y$n5s8 y$v_done)))))
(check-sat)
(exit)
