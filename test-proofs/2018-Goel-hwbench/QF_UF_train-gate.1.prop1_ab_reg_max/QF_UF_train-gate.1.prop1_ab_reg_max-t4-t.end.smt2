...
(assert (not (not (= (= y$1407 (= y$prop y$1406)) (= y$1407 (= y$1406 y$prop))))))
(assert (not (not (= y$1407 (= y$prop y$1406)))))
(assert (not (= y$1407 (= y$1406 y$prop))))
(assert (or (not (= (= y$1407 (= y$prop y$1406)) (= y$1407 (= y$1406 y$prop)))) (not (= y$1407 (= y$prop y$1406))) (= y$1407 (= y$1406 y$prop))))
(check-sat)
(exit)
