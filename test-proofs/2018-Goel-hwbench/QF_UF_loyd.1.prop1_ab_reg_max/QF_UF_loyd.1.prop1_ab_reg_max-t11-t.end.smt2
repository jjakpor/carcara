...
(assert (not (not (= (= y$630 (= y$prop y$629)) (= y$630 (= y$629 y$prop))))))
(assert (not (not (= y$630 (= y$prop y$629)))))
(assert (not (= y$630 (= y$629 y$prop))))
(assert (or (not (= (= y$630 (= y$prop y$629)) (= y$630 (= y$629 y$prop)))) (not (= y$630 (= y$prop y$629))) (= y$630 (= y$629 y$prop))))
(check-sat)
(exit)
