...
(assert (not (not (= (= (= y$n15s4 y$X) y$6) (= y$6 (= y$X y$n15s4))))))
(assert (not (not (= (= y$n15s4 y$X) y$6))))
(assert (not (= y$6 (= y$X y$n15s4))))
(assert (or (not (= (= (= y$n15s4 y$X) y$6) (= y$6 (= y$X y$n15s4)))) (not (= (= y$n15s4 y$X) y$6)) (= y$6 (= y$X y$n15s4))))
(check-sat)
(exit)
