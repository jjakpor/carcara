...
(assert (not (not (= (= y$27 (not (= y$n15s4 y$X$next))) (= y$27 (not (= y$X$next y$n15s4)))))))
(assert (not (not (= y$27 (not (= y$n15s4 y$X$next))))))
(assert (not (= y$27 (not (= y$X$next y$n15s4)))))
(assert (or (not (= (= y$27 (not (= y$n15s4 y$X$next))) (= y$27 (not (= y$X$next y$n15s4))))) (not (= y$27 (not (= y$n15s4 y$X$next)))) (= y$27 (not (= y$X$next y$n15s4)))))
(check-sat)
(exit)
