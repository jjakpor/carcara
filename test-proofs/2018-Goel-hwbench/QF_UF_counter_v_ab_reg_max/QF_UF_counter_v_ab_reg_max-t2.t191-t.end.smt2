...
(assert (not (not (= (= y$42 (not y$44)) (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))))
(assert (not (not (= y$42 (not y$44)))))
(assert (not (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(assert (or (not (= (= y$42 (not y$44)) (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4))))) (not (= y$42 (not y$44))) (not (= y$n15s4 (Add_4_4_4 y$n1s4 y$n1s4)))))
(check-sat)
(exit)
