...
(assert (not (not (= (= y$33 (= y$n15s4 y$s$1_op)) (= y$33 (= y$n15s4 (Add_4_4_4 y$X y$n1s4)))))))
(assert (not (not (= y$33 (= y$n15s4 y$s$1_op)))))
(assert (not (= y$33 (= y$n15s4 (Add_4_4_4 y$X y$n1s4)))))
(assert (or (not (= (= y$33 (= y$n15s4 y$s$1_op)) (= y$33 (= y$n15s4 (Add_4_4_4 y$X y$n1s4))))) (not (= y$33 (= y$n15s4 y$s$1_op))) (= y$33 (= y$n15s4 (Add_4_4_4 y$X y$n1s4)))))
(check-sat)
(exit)
