...
(assert (not (= (= y$58 (and y$2 y$13 y$28 y$26 y$45 y$44)) (= y$58 (and (= y$X y$n1s4) (= y$X$next (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X)) (= (not y$26) (not (= y$X$next y$n15s4))) y$26 y$45 y$44)))))
