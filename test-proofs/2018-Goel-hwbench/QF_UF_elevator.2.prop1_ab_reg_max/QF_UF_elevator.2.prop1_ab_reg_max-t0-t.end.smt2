...
(assert (not (not (= y$id36_op (and y$25 y$v3_1517448494_34_op)))))
(assert (not (not y$id36_op)))
(assert (not (and y$25 y$v3_1517448494_34_op)))
(assert (or (not (= y$id36_op (and y$25 y$v3_1517448494_34_op))) (not y$id36_op) (and y$25 y$v3_1517448494_34_op)))
(check-sat)
(exit)
