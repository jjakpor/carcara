...
(assert (not (not (= (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8) false))))
(assert (not (not (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8))))
(assert (not false))
(assert (or (not (= (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8) false)) (not (distinct y$n0s8 y$n1s8 y$n255s8 y$n5s8)) false))
(check-sat)
(exit)
