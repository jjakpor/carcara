...
(assert (not (not (= y$id44_op (= y$n5s8 y$v_k_Table)))))
(assert (not (not y$id44_op)))
(assert (not (= y$n5s8 y$v_k_Table)))
(assert (or (not (= y$id44_op (= y$n5s8 y$v_k_Table))) (not y$id44_op) (= y$n5s8 y$v_k_Table)))
(check-sat)
(exit)
