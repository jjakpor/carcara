...
(assert (not (not (= y$68 (= y$v_at_press y$v_at_table)))))
(assert (not (not y$68)))
(assert (not (= y$v_at_press y$v_at_table)))
(assert (or (not (= y$68 (= y$v_at_press y$v_at_table))) (not y$68) (= y$v_at_press y$v_at_table)))
(check-sat)
(exit)
