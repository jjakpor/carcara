...
(assert (not (not (= (= y$1526 (= y$prop y$1525)) (= y$1526 (= y$1525 y$prop))))))
(assert (not (not (= y$1526 (= y$prop y$1525)))))
(assert (not (= y$1526 (= y$1525 y$prop))))
(assert (or (not (= (= y$1526 (= y$prop y$1525)) (= y$1526 (= y$1525 y$prop)))) (not (= y$1526 (= y$prop y$1525))) (= y$1526 (= y$1525 y$prop))))
(check-sat)
(exit)
