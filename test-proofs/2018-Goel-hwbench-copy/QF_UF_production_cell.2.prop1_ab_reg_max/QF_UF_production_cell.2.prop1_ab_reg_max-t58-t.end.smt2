...
(assert (not (not (= y$76 (= y$v_k_Belt y$v_k_Deposit)))))
(assert (not (not y$76)))
(assert (not (= y$v_k_Belt y$v_k_Deposit)))
(assert (or (not (= y$76 (= y$v_k_Belt y$v_k_Deposit))) (not y$76) (= y$v_k_Belt y$v_k_Deposit)))
(check-sat)
(exit)
