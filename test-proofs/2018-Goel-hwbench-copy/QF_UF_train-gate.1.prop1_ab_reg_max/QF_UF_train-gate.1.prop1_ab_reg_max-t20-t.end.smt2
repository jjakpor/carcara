...
(assert (not (not y$v3_1517448508_35_op)))
(assert (not (and y$a_Cross_Train_1 y$a_Cross_Train_2)))
(assert (or (not y$v3_1517448508_35_op) (and y$a_Cross_Train_1 y$a_Cross_Train_2)))
(check-sat)
(exit)
