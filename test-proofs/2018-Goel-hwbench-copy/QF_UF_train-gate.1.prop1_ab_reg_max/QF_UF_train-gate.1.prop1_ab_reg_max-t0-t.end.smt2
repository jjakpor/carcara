...
(assert (not (not (= y$id37_op (and y$45 y$v3_1517448508_35_op)))))
(assert (not (not y$id37_op)))
(assert (not (and y$45 y$v3_1517448508_35_op)))
(assert (or (not (= y$id37_op (and y$45 y$v3_1517448508_35_op))) (not y$id37_op) (and y$45 y$v3_1517448508_35_op)))
(check-sat)
(exit)
