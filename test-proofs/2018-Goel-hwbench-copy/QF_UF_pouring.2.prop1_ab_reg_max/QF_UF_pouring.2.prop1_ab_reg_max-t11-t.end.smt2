...
(assert (not (not (= (= y$55379 (= y$prop y$55378)) (= y$55379 (= y$55378 y$prop))))))
(assert (not (not (= y$55379 (= y$prop y$55378)))))
(assert (not (= y$55379 (= y$55378 y$prop))))
(assert (or (not (= (= y$55379 (= y$prop y$55378)) (= y$55379 (= y$55378 y$prop)))) (not (= y$55379 (= y$prop y$55378))) (= y$55379 (= y$55378 y$prop))))
(check-sat)
(exit)
