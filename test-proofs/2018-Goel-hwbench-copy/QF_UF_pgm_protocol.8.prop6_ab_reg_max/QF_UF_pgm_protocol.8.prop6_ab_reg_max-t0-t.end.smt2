...
(assert (not (not (= y$id185_op (and y$111 y$v3_1517448504_183_op)))))
(assert (not (not y$id185_op)))
(assert (not (and y$111 y$v3_1517448504_183_op)))
(assert (or (not (= y$id185_op (and y$111 y$v3_1517448504_183_op))) (not y$id185_op) (and y$111 y$v3_1517448504_183_op)))
(check-sat)
(exit)
