...
(assert (not (not (= (= y$1518 (= y$prop y$1517)) (= y$1518 (= y$1517 y$prop))))))
(assert (not (not (= y$1518 (= y$prop y$1517)))))
(assert (not (= y$1518 (= y$1517 y$prop))))
(assert (or (not (= (= y$1518 (= y$prop y$1517)) (= y$1518 (= y$1517 y$prop)))) (not (= y$1518 (= y$prop y$1517))) (= y$1518 (= y$1517 y$prop))))
(check-sat)
(exit)
