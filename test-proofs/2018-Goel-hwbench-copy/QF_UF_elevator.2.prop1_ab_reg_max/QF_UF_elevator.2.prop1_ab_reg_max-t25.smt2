...
(assert (or (not (and y$a_in_elevator_Person_0 y$a_in_elevator_Person_1)) y$a_in_elevator_Person_0))
(assert (not y$a_in_elevator_Person_0))
(assert (not (not (and y$a_in_elevator_Person_0 y$a_in_elevator_Person_1))))
(check-sat)
(exit)
