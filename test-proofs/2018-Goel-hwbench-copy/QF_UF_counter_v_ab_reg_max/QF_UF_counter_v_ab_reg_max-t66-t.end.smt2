...
(assert (not (not (= (= y$13 (= y$X$next y$X$next_rhs_op)) (= y$13 (= y$X$next (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X)))))))
(assert (not (not (= y$13 (= y$X$next y$X$next_rhs_op)))))
(assert (not (= y$13 (= y$X$next (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X)))))
(assert (or (not (= (= y$13 (= y$X$next y$X$next_rhs_op)) (= y$13 (= y$X$next (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X))))) (not (= y$13 (= y$X$next y$X$next_rhs_op))) (= y$13 (= y$X$next (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X)))))
(check-sat)
(exit)
