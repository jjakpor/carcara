...
(assert (not (not (= (= y$28 (= y$27 y$prop$next)) (= y$28 (= y$prop$next (not (= y$X$next y$n15s4))))))))
(assert (not (not (= y$28 (= y$27 y$prop$next)))))
(assert (not (= y$28 (= y$prop$next (not (= y$X$next y$n15s4))))))
(assert (or (not (= (= y$28 (= y$27 y$prop$next)) (= y$28 (= y$prop$next (not (= y$X$next y$n15s4)))))) (not (= y$28 (= y$27 y$prop$next))) (= y$28 (= y$prop$next (not (= y$X$next y$n15s4))))))
(check-sat)
(exit)
