...
(assert (not (not (= (= y$X$next_rhs_op (ite y$en y$s$4_op y$X)) (= y$X$next_rhs_op (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X))))))
(assert (not (not (= y$X$next_rhs_op (ite y$en y$s$4_op y$X)))))
(assert (not (= y$X$next_rhs_op (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X))))
(assert (or (not (= (= y$X$next_rhs_op (ite y$en y$s$4_op y$X)) (= y$X$next_rhs_op (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X)))) (not (= y$X$next_rhs_op (ite y$en y$s$4_op y$X))) (= y$X$next_rhs_op (ite y$en (ite (= y$X y$n15s4) y$n1s4 (Add_4_4_4 y$X y$n1s4)) y$X))))
(check-sat)
(exit)
