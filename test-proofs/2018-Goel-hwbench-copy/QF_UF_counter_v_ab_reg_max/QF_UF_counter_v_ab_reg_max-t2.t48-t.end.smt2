...
(assert (not (not (= (= y$28 (= y$prop$next y$27)) (= y$28 (= y$27 y$prop$next))))))
(assert (not (not (= y$28 (= y$prop$next y$27)))))
(assert (not (= y$28 (= y$27 y$prop$next))))
(assert (or (not (= (= y$28 (= y$prop$next y$27)) (= y$28 (= y$27 y$prop$next)))) (not (= y$28 (= y$prop$next y$27))) (= y$28 (= y$27 y$prop$next))))
(check-sat)
(exit)
