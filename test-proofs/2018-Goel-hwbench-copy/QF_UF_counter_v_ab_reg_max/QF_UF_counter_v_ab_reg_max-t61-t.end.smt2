...
(assert (not (not (= (= y$2 (= y$n1s4 y$X)) (= y$2 (= y$X y$n1s4))))))
(assert (not (not (= y$2 (= y$n1s4 y$X)))))
(assert (not (= y$2 (= y$X y$n1s4))))
(assert (or (not (= (= y$2 (= y$n1s4 y$X)) (= y$2 (= y$X y$n1s4)))) (not (= y$2 (= y$n1s4 y$X))) (= y$2 (= y$X y$n1s4))))
(check-sat)
(exit)
